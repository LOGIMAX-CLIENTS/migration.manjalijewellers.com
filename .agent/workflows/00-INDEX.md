...
> 19 workflows in execution order. Use the slash command to run any workflow.
...
| #   | Slash Command         | Purpose                                                                              |
| --- | --------------------- | ------------------------------------------------------------------------------------ |
| 8   | `/build-system-brain` | Build cross-module \_SYSTEM/ brain — shared tables, dependencies, integration points |
...
| 10  | `/fix-architecture-bug` | Fix Track A (system) bugs — Antigravity-led      |
...
| #   | Slash Command         | Purpose                                                                  |
| --- | --------------------- | ------------------------------------------------------------------------ |
| 19  | `/get-requirement`    | Analyze task description → generate Category, Task, User Story, Observation, Impacts, Acceptance Criteria |
