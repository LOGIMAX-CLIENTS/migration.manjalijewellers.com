...
if ($row) {
    file_put_contents('template_45_regression_gjs.json', $row['gjs_data']);
    file_put_contents('template_45_regression_html.html', $row['template_html']);
    file_put_contents('template_45_regression_css.css', $row['template_css']);
