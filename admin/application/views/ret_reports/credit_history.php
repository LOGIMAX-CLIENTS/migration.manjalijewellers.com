            ...
            <div class="col-xs-12">
               ...
               <div class="box box-primary">
			    <div class="box-header with-border">
                  <h3 class="box-title">Credit History List</h3>  <span id="total_count" class="badge bg-green"></span>  
	                   ...
	                   <div class="box-body">  
						   <div class="row">
								...
								<div class="col-md-2"> 
									<label></label>
									<div class="form-group">
										<button type="button" id="credit_history_search" class="btn btn-info">Search</button>   
									</div>
								</div>
							</div>
						 </div>
