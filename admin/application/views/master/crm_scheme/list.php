              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Scheme List</h3>    <span id="total_schemes" class="badge bg-green"></span>   
                           <a class="btn btn-success pull-right" id="add_scheme" href="<?php echo base_url('index.php/crm_mas_scheme/sch_form/Add'); ?>"><i class="fa fa-user-plus"></i> Add</a> 
                </div><!-- /.box-header -->
                <div class="box-body">
                <!-- Alert -->
                <?php 
	            ...
	            <?php } ?>      
                  ...
                  <table id="crm_scheme_list" class="table grid table-bordered table-striped text-center">
                    <thead>
                      <tr>
                        <th>ID</th>
                        <th>Name</th>
                        <th>Sch & Sync Sch Code</th>
                        <th>Type</th>                        
