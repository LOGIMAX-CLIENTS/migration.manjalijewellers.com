            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Customer List</h3> <span id="total_customers"
                            class="badge bg-green"></span>
                        <div class="pull-right">
                            <a class="btn btn-success pull-right" id="add_customer"
                                href="<?php echo base_url('index.php/customer/add'); ?>"><i
                    ...
                    <div class="form-group">
                       <button class="btn btn-default btn_date_range" id="customer-dt-btn">
                        ...
                        <i class="fa fa-caret-down"></i>
                            ...
                            <div class="col-md-2">
                                <span id="customer_date_range" style="font-weight:bold;"></span>
                                <div class="form-group">
                                    <button class="btn btn-default btn_date_range" id="customer-dt-btn">
                                        <span style="display:none;" id="customer_list1"></span>
                                        <span style="display:none;" id="customer_list2"></span>
                                        <i class="fa fa-calendar"></i> Date range picker
                                        <i class="fa fa-caret-down"></i>
                                    </button>
                                </div>
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    ...
                                    <select id="religion_select" class="form-control">
                                        <option value="0"> Select Religion Name</option>
                                        <option value="1">Hindu</option>
                                        <option value="2">Muslim</option>
                                        <option value="3">Christian</option>
                                    </select>
                                    <input type="hidden" id="id_religion">
                                </div>
                            </div>
                    ...
                    <button type="submit" class="btn btn-primary" id="send-login-email"><i class="fa fa-envelope-o"></i> Send Login Email</button>
                            ...
                            <div class="col-sm-2">
                                <br />
                                <button type="submit" class="btn btn-success" id="bulk_allocate_agent"><i
                                        class="fa fa-envelope-o"></i>Allocate To Agent</button>
                            </div>
                            <div class="col-sm-2">
                                <br/>
                                <button type="submit" class="btn btn-success" id="bulk_allocate_employee"><i class="fa fa-envelope-o"></i>Allocate To Employee</button>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    <button id="btnExport" onclick="fnCusItemsExcelReport('1');"
                                        class="btn btn-success "><i class="fa fa-file-excel-o"></i>&nbsp;Export excel</button>
                                </div>
                            </div>
                        </div>
                        <br />
                        ...
                        <div class="table-responsive">
                            <table id="customer_list" class="table table-bordered table-striped text-center">
                                <thead>
                                    <tr>
                                        <th><label class="checkbox-inline"><input type="checkbox" id="select_all"
                                                    name="select_all" value="all" />All</label></th>
                                        <th>Name</th>
                                        <th>Mobile</th>
                                        <th>Accounts</th>
                                        <!--    <?php if ($entry_date[0]['edit_custom_entry_date'] == 1) { ?>
...
<!-- / modal -->
<!--Bulk allocate Customer to agent modal -->
<div class="modal fade" id="allocate_agent_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span
                        class="sr-only">Close</span></button>
                <h4 class="modal-title" id="myModalLabel">Allocate Customer To Agent</h4>
            </div>
            <div class="modal-body">
                <div class="form-group col-sm-8">
                    <label>Select Agent</label>
                    <select id="agent_select" class="form-control"></select>
                    <input type="hidden" id="id_agent">
                </div>
                </br></br></br>
            </div>
            <div class="modal-footer">
                <a href="#" id="allocate_agent_btn" class="btn btn-success btn-confirm">Allocate</a>
...
<div class="modal fade" id="kyc_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
...
<!--Bulk allocate Customer to agent modal -->
<div class="modal fade" id="allocate_employee_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
<div class="modal-dialog">
<div class="modal-content">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
        <h4 class="modal-title" id="myModalLabel">Allocate Customer To Employee</h4>
    </div>
    ...
    <div class="modal-footer">
        <a href="" id="allocate_employee_btn" class="btn btn-success btn-confirm" >Allocate</a>
        <button type="button" class="btn btn-warning" data-dismiss="modal">Cancel</button>
    </div>
</div>
</div>
