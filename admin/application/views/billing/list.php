  <!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
           Billing
            <small>Managerr Billing(s)</small><span id="total_billing" class="badge bg-green"></span> 
          </h1>
          <ol class="breadcrumb">
	                   ...
	                   <div class="box-body">  
                        ...
                        <input type="hidden" id="id_branch"  value="">
						        ...
						        <div class="col-md-3"> 
									<div class="form-group">    
            		                    <div class="input-group">
            		                        <br>
            		                       <button class="btn btn-default btn_daterange" id="rpt_date_picker">
								...
								<div class="col-md-2"> 
									<label></label>
									<div class="form-group">
										<button type="button" id="bill_search" class="btn btn-info">Search</button>   
									</div>
								</div>
							</div>
						 </div>
...
<div class="modal fade" id="confirm-billcancell" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
        ...
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="col-md-12 bill_remarks">
                    ...
                    <input type ="hidden" id="billed_branch" name="">
