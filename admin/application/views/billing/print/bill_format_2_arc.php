...
<head>
	...
	<style>
		...
		@page {
			...
			margin-top: 6.6cm;     /* Start position */
    		margin-bottom: 3cm;
			margin-left: 25px;
			margin-right: 25px;
	...
	<div class="PDFReceipt">
		...
		<table class=paging>
						...
						<div class="content-block">
							...
							if (sizeof($est_other_item['item_details']) > 0) //SALES BILL 
							{
								if ($billing['bill_type'] == 15) {
									$invoice_no = $billing['is_eda'] == 2 ? 'SA-' . $billing['approval_ref_no'] : '';
								} else {
									$invoice_no = $billing['is_eda'] == 2 ? 'SA-' . $billing['sales_ref_no'] : '';
								}
							} else if (sizeof($est_other_item['old_matel_details']) > 0) // OLD METAL ITEMS
							{
								$invoice_no =  $billing['is_eda'] == 2 ? 'PU-' . $billing['pur_ref_no'] : '';
							} else if (sizeof($est_other_item['return_details']) > 0) //SALES RETURN
							{
								$invoice_no =  $billing['is_eda'] == 2 ? 'SR-' . $billing['s_ret_refno'] : '';
							} else if ($billing['bill_type'] == 5) //ORDER ADVANCE
							{
								$invoice_no = $billing['is_eda'] == 2 ?  'OR-' . $billing['order_adv_ref_no'] : '';
							} else if ($billing['bill_type'] == 8)   //CREDIT COLLECTION
							{
								$invoice_no = $billing['is_eda'] == 2 ?  'CC-' . $billing['credit_coll_refno'] : '';
							...
							<div style="width:100%;" class="new_tax">
								<div style="text-decoration: underline; text-align:center;"> <?php echo ($billing['is_eda'] == 1 ? '' : '') ?> </div>
								<span style="text-align:center;font-size: 12px;text-transform:none;"> <?= ($billing['is_today'] == 1 ? '' : '') ?> </span>
							</div>
							<div class="wrapper">
								<div id="a1">
									<?php
									if ($billing['is_eda'] == 1) {
										if ($billing['billing_for'] == 1 || $billing['billing_for'] == 2) { ?>
                                    	...
                                    	<label><?php echo ($billing['cus_country'] != '' ? 'Country:&nbsp;&nbsp;' . strtoupper($billing['cus_country']) : ''); ?></label><br> -->
											...
											<label><?php echo (isset($billing['driving_license_no']) && $billing['driving_license_no'] != '' ? '<br>PASSPORT NO:&nbsp;&nbsp;' . strtoupper($billing['driving_license_no']) . '' : ''); ?></label>
												<label><?php echo  '<br>MOBILE: ' . $billing['mobile']; ?></label>
												<?php
												if (!empty($billing['irnno'])) { ?>
													<label style="font-weight: bold;">
														IRN&nbsp;:<span style="overflow-wrap: break-word">&nbsp;<?php echo $billing['irnno']; ?> </span>
													</label>
												<?php } ?>
											</div>
										...
										<?php } else { ?>
											<div>
												...
												<label><?php echo '<br>GSTIN:&nbsp;&nbsp;' . $billing['transfer_details']['gst_number']; ?></label>
											</div>
										<?php } ?>
									<?php } else { ?>
										<div>
								...
								<div id="a2">
									...
									<?php if ($billing['is_eda'] == 1) {
												...
												if (!empty($billing['irnno'])) {
													...
													echo $imageTag . "<br>Scan for softcopy";
											?>
									...
									<div>
										<table style="font-weight:bold;">
											<tr>
												...
												<td style="width:50%;"><?php echo $billing['is_eda'] == 1 ? $inv_no : $invoice_no; ?></td>
											</tr>
											<tr>
												<td><label>Date - Time</label></td>
												<td>:</td>
												<td><?php echo $billing['bill_date'] . " - " . $billing['bill_time']; ?></td>
											</tr>
											<!-- <tr>
												<td><label>Time</label></td>
												<td>:</td>
												<td><?php //echo $billing['bill_time']; 
													?></td>
											</tr> -->
											<tr>
											...
											<?php if ($billing['state_code'] != '') { ?>
												<!-- <tr>
													...
													<td>:</td>
													<td><?php //echo $billing['state_code']; 
														?></td>
												</tr> -->
											<?php  } ?>
										</table>
							...
							<div>
								...
								if ($billing['bill_type'] == 9) {
									$title =  $billing['is_eda'] == 1 ? "ORDER DELIVERY" : "ORDER DELIVERY PROFORMA";
								} elseif (sizeof($est_other_item['item_details']) > 0 && sizeof($est_other_item['old_matel_details']) > 0) {
									$title = $billing['is_eda'] == 1 ? "SALES AND PURCHASE BILL" : "SALES AND PURCHASE PROFORMA";
								} elseif (sizeof($est_other_item['item_details']) > 0 && sizeof($est_other_item['old_matel_details']) == 0) {
									$title = $billing['is_eda'] == 1 ? "SALES BILL" : "SALES PROFORMA";
									if ($billing['is_to_be'] == 1) {
										$title = $billing['is_eda'] == 1 ? "TO BE " . $title : "TO BE PROFORMA";
									}
								} elseif ($billing['bill_type'] == 5) {
									$title = $billing['is_eda'] == 1 ?  "ORDER ADVANCE" : "ORDER ADVANCE PROFORMA";
								} elseif ($billing['bill_type'] == 7) {
									$title = $billing['is_eda'] == 1 ? "SALES RETURN" : "SR PROFORMA";
								} elseif ($billing['bill_type'] == 8) {
									$title = $billing['is_eda'] == 1 ? "CREDIT COLLECTION" : "CREDIT RECEIPT PROFORMA";
								}
								?>
					...
					<td>
							...
							<div class="box">
								<div class="box-body">
														...
														<table id="pp" class="table">
															<thead style="text-transform:uppercase;font-size:12px;">
																...
																<tr>
																	...
																	<th class="table_heading textOverflowHidden" style="width: 40%; text-align:left;">Description </th>
																	<th class="table_heading alignRight" style="width: 12%;">HSN</th>
																	<th class="table_heading alignRight" style="width: 10%;">PCS</th>
																	<th class="table_heading alignRight" style="width: 10%;">GRS.WT</th>
																	<th class="table_heading alignRight" style="width: 10%;">NET.WT</th>
																	<!-- <th class="table_heading alignRight" style="width: 10%;">Rate</th> -->
																	<!-- <th class="table_heading alignRight" style="width: 10%;"></th> -->
																	<th class="table_heading alignRight" style="width: 13%;">Amount</th>
																</tr>
															</thead>
															...
															<tbody>
																...
																?>
																	...
																	<?php if ($items['calculation_based_on'] != 4) { ?>
																		<tr>
																			<td style="text-align:center"><?php echo $i; ?></td>
																			<td style="text-align:left;" class="textOverflowHidden"><?php echo ($items['is_delivered'] == 0 ? '*' : '') ?>
																				<!-- <?php echo $items['product_name']; ?> -->
																				<?php echo $items['design_name']; ?>
																			</td>
																		...
																		<td class="alignRight"><?php echo $items['net_wt'] . ($items['pro_uom'] != '' ? '-' . $items['pro_uom'] : '') ?></td> -->
																			<td class="alignRight"><?php echo ($items['calculation_based_on'] != 3 && $items['calculation_based_on'] != 4 ? $items['gross_wt'] : ''); ?></td>
																			<td class="alignRight"><?php echo ($items['calculation_based_on'] != 3 && $items['calculation_based_on'] != 4 ? $items['net_wt'] : ''); ?></td>
																			<!-- <td class="alignRight">
																		<?php
																		if ($items['net_wt'] >= 1) {
																		...
																		?> 
																			...
																			<!-- <td style="width: 15%" class="alignRight"><?php echo ($items['calculation_based_on'] != 3 && $items['calculation_based_on'] != 4 ? ($item_wastge_wt > 0 ? number_format($item_wastge_wt, 3, '.', '') : '') : ''); ?></td> -->
																			...
																			<!-- <td class="alignRight"><?php //echo $mc > 0 ? moneyFormatIndia(number_format($mc, 2, '.', '')) : ''; 
																										?></td> -->
																			<!-- <td style="width: 15%" class="alignRight"><?php echo ($items['calculation_based_on'] != 3 && $items['calculation_based_on'] != 4 ? ($mc > 0 ? moneyFormatIndia(number_format($mc, 0, '.', '')) : '') : ''); ?></td> -->
																			<!-- <td class="alignRight"><?php //echo moneyFormatIndia($items['rate_per_grm']); 
																										?></td> -->
																			<!-- <td class="alignRight">
																			<?php echo $items['rate_per_grm']; ?>
																		</td> -->
																			<td class="alignRight" colspan=""><?php echo moneyFormatIndia(number_format((float)($item_taxable > 0 ? ($item_taxable) : 0), 2, '.', '')); ?></td>
																		</tr>
																	<?php } else { ?>
																		<tr>
																			<td style="text-align:center"><?php echo $i; ?></td>
																			<td style="text-align:left;" class="textOverflowHidden">
																				<!-- <?php echo $items['product_name']; ?> -->
																				<?php echo $items['design_name']; ?>
																			</td>
																			<td class="alignRight"><?php echo $items['hsn_code']; ?></td>
																	...
																	?>
																			<tr class="stones">
																				...
																				<?php if ($stoneItems['stone_cal_type'] == 1) { ?>
																					<td colspan="4" class='textOverflowHidden stoneData'><?php echo $stoneItems['pieces'] . ' Pcs ' . $stoneItems['stone_name'] . ' ' . number_format($stoneItems['wt'], 3, '.', '') . ' ' . $stoneItems['uom_short_code'] . ($stoneItems['amount'] > 0 ?  'x' . moneyFormatIndia(number_format($stoneItems['rate_per_gram'], 2, '.', '')) . '=' . moneyFormatIndia(number_format((float)($stoneItems['amount']), 2, '.', '')) : ''); ?></td>
															...
															<tr class="total" style="font-weight: bold">
																...
																<td class="alignRight"><?php echo ($billing['calculation_based_on'] != 4 && $billing['calculation_based_on'] != 3 ? (number_format($gross_wt, 3, '.', '')) : ''); ?></td>
																<td class="alignRight"><?php echo ($billing['calculation_based_on'] != 4 && $billing['calculation_based_on'] != 3 ? (number_format($net_wt, 3, '.', '')) : ''); ?></td>
									...
									<?php if (sizeof($est_other_item['return_details']) > 0) { ?>
										...
										<div class="sub_inv">
											<span><?php echo ($billing['is_eda'] == 2 ? 'Sales Return Proforma No : ' : ' Sales Return Invoice No : ');
													$ret_no = $this->ret_billing_model->get_bill_no_format_detail($billing['bill_id'], 'sr');
													if ($billing['is_eda'] == 2) {

														$sr_split = explode("-", $ret_no);
										...
										<table id="pp" class="table text-center">
											...
											<thead style="text-transform:uppercase;font-size:12px;">
												<tr>
													<th class="table_heading alignCenter" style="width: 5%; text-align:center;">S.No</th>
													<th class="table_heading textOverflowHidden" style="width: 35%; text-align:left;">Description </th>
													<th class="table_heading alignRight" style="width: 10%;">HSN</th>
													<th class="table_heading alignRight" style="width: 5%;">PCS</th>
													<th class="table_heading alignRight" style="width: 15%;">GRS.WT</th>
													<th class="table_heading alignRight" style="width: 15%;">NET.WT</th>
											...
											<tr style="font-weight:bold; text-transform: uppercase;">
												<td colspan="7"><?= $billing['is_eda'] == 2 ? "Exchange (Refer Sale Proforma no :" : "Exchange (Refer sale bill no :" ?><?php
																																										$ref_no_sale = $this->ret_billing_model->get_bill_no_format_detail($est_other_item['return_details'][0]['ret_bill_id']);
																																										if ($billing['is_eda'] == 2) {

																																											$split = explode("-", $ref_no_sale);
											...
											?>
												...
												<tr>
													...
													<td class="textOverflowHidden"><?php echo $items['product_name']; ?></td>
													<td class="alignRight"><?php echo $items['hsn_code']; ?></td>
													<td class="alignRight"><?php echo $items['piece']; ?></td>
													<td class="alignRight"><?php echo ($items['calculation_based_on'] != 3 && $items['calculation_based_on'] != 4 ? $items['gross_wt'] : ''); ?></td>
													<td class="alignRight"><?php echo ($items['calculation_based_on'] != 3 && $items['calculation_based_on'] != 4 ? $items['net_wt'] : ''); ?></td>
													...
													<!-- <td style="width: 15%" class="alignRight"><?php //echo moneyFormatIndia($items['rate_per_grm']); 
																									?></td> -->
											...
											<tr style="font-weight: bold">
												...
												<td></td>
												<td class="alignRight"><?php echo $pieces ?></td>
												<td class="alignRight"><?php echo ($items['calculation_based_on'] != 3 && $items['calculation_based_on'] != 4 ? number_format($gross_wt, 3, '.', '') : ''); ?></td>
												<td class="alignRight"><?php echo ($items['calculation_based_on'] != 3 && $items['calculation_based_on'] != 4 ? number_format($net_wt, 3, '.', '') : ''); ?></td>
											...
											if ($pur_total_amt == 0) {
												...
												<?php if ($tot_sales_amt + $billing['handling_charges'] > 0) { ?>
													<tr>
														<td colspan="3"></td>
														<td colspan="2" class="alignRight" style="white-space:nowrap;">Sales Amount</td>
														<td class="alignRight" style="font-size:15px !important;">&#8377;</td>
												...
												<?php if ($total_return > 0) { ?>
													<tr>
														<td colspan="2"></td>
														<td colspan="3" class="alignRight" style="white-space:nowrap;">Exchange Amount</td>
														<td class="alignRight" style="font-size:15px !important;">&#8377;</td>
														<td class="alignRight"><?php echo moneyFormatIndia(number_format($total_return - $billing['credit_due_amt'] - $round_off, 2, '.', '')); ?></td>
													</tr>
												<?php } ?>
												...
												<!-- <?php if ($total_return > 0) { ?>
													<tr>
														<td colspan="4"></td>
														<td colspan="2" class="alignRight" style="white-space:nowrap;">Return Charges</td>
														<td class="alignRight" style="font-size:15px !important;">&#8377;</td>
												...
												<?php if ($tot_sales_amt > 0 && $total_return > 0) { ?>
													...
													<tr>
														<td colspan="3"></td>
														<td colspan="2" class="alignRight" style="white-space:nowrap;">Net Amount</td>
														<td class="alignRight" style="font-size:15px !important;">&#8377;</td>
											...
											<div class="table-responsive">
												...
												<table id="pp" class="table text-center">
													...
													<tr style="text-transform:uppercase;font-size:12px;">
														...
														<th class="table_heading alignRight" style="width: 10%;">GRS.WT</th>
														<th class="table_heading alignRight" style="width: 10%;">NET.WT</th>
														<th class="table_heading alignRight" style="width: 10%;"></th><!-- V.A -->
														<th class="table_heading alignRight" style="width: 12%;"></th><!-- MC -->
													...
													foreach ($est_other_item['order_details'] as $items) {
														...
														if ($items['calculation_based_on'] == 0) {
															// $wastge_wt = ($items['gross_wt'] * ($items['wastage_percent'] / 100));
															$mc = ($items['id_mc_type'] == 2 ? ($items['mc'] * $items['weight']) : ($items['mc'] * $items['totalitems']));
														} else if ($items['calculation_based_on'] == 1) {
															// $wastge_wt = ($items['net_wt'] * ($items['wastage_percent'] / 100));
															$mc = ($items['id_mc_type'] == 2 ? ($items['mc'] * $items['net_wt']) : ($items['mc'] * $items['totalitems']));
														} else if ($items['calculation_based_on'] == 2) {
															// $wastge_wt = ($items['net_wt'] * ($items['wastage_percent'] / 100));
															$mc = ($items['id_mc_type'] == 2 ? ($items['mc'] * $items['weight']) : ($items['mc'] * $items['totalitems']));
														}
														$va_weight = number_format(($od_wastage_amt + $mc) / $items['rate_per_gram'], 3, '.', '');
														$stone_amount = 0;
													...
													?>
														<tr>
															<td class="alignCenter"><?php echo $i; ?></td>
															<td class='textOverflowHidden '>
																<!-- <?php echo $items['product_name']; ?> -->
																<?php echo $items['sub_design_name']; ?>
															</td>
															<td class="alignRight"><?php echo $items['hsn_code']; ?></td>
															...
															<!-- <td class="alignRight"><?php
																						...
																						?> </td> -->
															<td class="alignRight"></td><!-- VA empty -->
															<td style="width: 15%" class="alignRight"></td><!-- MC empty -->
													...
													<?php if (($od_total_cgst > 0 || $od_total_sgst > 0) && $billing['is_eda'] == 1) { ?>
														...
														<tr>
															...
															<td class="alignRight" style="font-size:15px !important;">&#8377;</td>
															<td class="alignRight"><?php echo moneyFormatIndia($od_total_cgst); ?></td>
														</tr>
														...
														<tr>
															...
															<td class="alignRight" style="font-size:15px !important;">&#8377;</td>
															<td class="alignRight"><?php echo moneyFormatIndia($od_total_sgst); ?></td>
														</tr>
													...
													<?php if ($od_total_igst > 0 && $billing['is_eda'] == 1) { ?>
														...
														<tr>
															...
															<td class="alignRight" style="font-size:15px !important;">&#8377;</td>
															<td class="alignRight"><?php echo moneyFormatIndia($od_total_igst); ?></td>
														</tr>
													...
													<?php if ($od_total_price > 0) {
														...
														if ($billing['is_eda'] == 2) {
															...
															if ($od_total_cgst > 0 || $od_total_sgst > 0) {

																$od_total_price = $od_total_price - ($od_total_cgst + $od_total_sgst);
															} elseif ($od_total_igst > 0) {

																$od_total_price -= $od_total_igst;
															}
														}
													...
													?>
														...
														<tr class="table_heading">
															<td colspan="5"></td>
															<td colspan="2" class="alignRight">Approx Total Amount</td>
															<td class="alignRight" style="font-size:15px !important;">&#8377;</td>
										...
										<table id="pp" class="table text-center">
											<thead style="text-transform:uppercase;font-size:10px; font-weight:bold;">
												<tr>
													...
													<td width="15%;" class="alignCenter">HSN</td>
													<td width="40%;">Description</td>
													<td width="10%;">PCS</td>
													<td width="15%;">Gwt(g)</td>
													<!-- <td class="alignRight" width="10%;">Rate</td> -->
											...
											?>
												...
												<tr>
													...
													<td><?php echo $items['piece']; ?></td>
													<td><?php echo $items['gross_wt']; ?></td>
													<!-- <td style="text-align:right;"><?php //echo moneyFormatIndia($items['rate_per_grm']); 
																						?></td> -->
						...
						<?php if (sizeof($est_other_item['old_matel_details']) > 0) { ?>
							...
							<?php if (sizeof($est_other_item['old_matel_details']) > 0 && sizeof($est_other_item['item_details']) == 0 && $billing['bill_type'] != 8) { ?>
								<div for="title" style="text-align:center;font-weight:bold;"><?php echo ($billing['is_eda'] == 2 ? "PURCHASE PROFORMA" : "PURCHASE BILL"); ?></div> <br>
							...
							?>
								<span style="font-size:12px !important; font-weight:bold; text-transform: uppercase;"><?= $billing['is_eda'] == 1 ? "Purchase Invoice No :" : "Purchase Proforma No :" ?>
									<?php
									if ($billing['is_eda'] == 2) {

										$pur_split = explode("-", $pur_inv_no);

										$pur_inv_no = $pur_split[2];
									}
									echo $pur_inv_no;
									?></span>
								<?php  ?>
							...
							<!-- <hr colspan="10" class="old_metal_dashed"> -->

							<table id="pp" class="table text-center" style="width: 100%; border-collapse: collapse;">
								...
								<tr style="text-transform:uppercase;font-size:12px;">
									<th class="table_heading alignCenter" style="width: 5% !important; text-align:center;">S.No</th>
									<th colspan="5" class="table_heading textOverflowHidden" style="width: 64% !important; text-align:left;">Description </th>
									<th class="table_heading alignRight" style="width: 10% !important;">NETWT</th>
									<th class="table_heading alignRight" style="width: 10% !important;">RATE</th>
									<th class="table_heading alignRight" style="width: 11% !important; ">Amount</th>
								</tr>
								...
								?>
									<tr>
										...
										<td style="font-size:10px; width:64%" colspan="5" class='textOverflowHidden'><?php echo $items['old_metal_type']; ?></td>
										<td style="width: 10%" class="alignRight"><?php echo number_format($items['net_wt'], 3, '.', ''); ?></td>
										<td style="width: 10%" class="alignRight"><?php echo moneyFormatIndia($items['rate_per_gram']); ?></td>
										<td style="width: 11%" class="alignRight"><?php echo moneyFormatIndia(number_format($items['amount'], 2, '.', '')); ?></td>
									</tr>
								<?php $i++;
								} ?>
								<!-- stone details-->
								...
								?>
										<tr class="stones">
											<td></td>
											<?php if ($stoneItems['stone_cal_type'] == 1) { ?>
												<td colspan="5" class='textOverflowHidden stoneData'><?php echo $stoneItems['pieces'] . ' Pcs ' . $stoneItems['stone_name'] . ($stoneItems['price'] > 0 ? ' ' . number_format($stoneItems['wt'], 3, '.', '') . ' ' . $stoneItems['uom_short_code'] . ' x ' . moneyFormatIndia(($stoneItems['rate_per_gram']), 2, '.', '') . '=' . moneyFormatIndia(number_format((float)($stoneItems['price']), 2, '.', '')) : ''); ?></td>
											<?php } else if ($stoneItems['stone_cal_type'] == 2) { ?>
												<td colspan="5" class='textOverflowHidden stoneData'><?php echo number_format($stoneItems['wt'], 3, '.', '') . ' ' . $stoneItems['uom_short_code'] . ' ' . $stoneItems['stone_name'] . ($stoneItems['price'] > 0 ? ' ' . $stoneItems['pieces'] . 'Pcs ' . 'x' . $stoneItems['rate_per_gram'] . '=' . moneyFormatIndia(number_format((float)($stoneItems['price']), 2, '.', '')) : ''); ?></td>
											<?php } ?>
											<td class="alignRight stoneData"></td>
											<td class="alignRight"></td>
											<td class="alignRight stoneData"></td>
			...
			<?php if ($tot_sales_amt + $billing['handling_charges'] > 0) { ?>
				<tr style="font-weight: bold">
					<td colspan="5"></td>
					<td class="alignRight" colspan="2" style="white-space:nowrap;">Sales Amount</td>
					<td class="alignRight" style="font-size:15px !important;">&#8377;</td>
			...
			<?php if ($total_return > 0) { ?>
								<tr style="font-weight: bold">
									<td colspan="5"></td>
									<td class="alignRight" colspan="2" style="white-space:nowrap;">Exchange Amount</td>
									<td class="alignRight" style="font-size:15px !important;">&#8377;</td>
									<td class="alignRight"><?php echo moneyFormatIndia(number_format($total_return, 2, '.', '')); ?></td>
								</tr>
			<?php } ?>
			<?php if ($pur_total_amt > 0) { ?>
				<tr style="font-weight:bold;">
					...
					<td class="alignRight" colspan="4" style="white-space:nowrap;">Purchase Amount</td>
					<td class="alignRight" style="font-size:15px !important;">&#8377;</td>
			...
			<?php if ($round_off != 0) { ?>
				<tr style="font-weight: bold">
										<td colspan="5"></td>
					<td class="alignRight" colspan="2" style="white-space:nowrap;">Round Off</td>
					<td class="alignRight" style="font-size:15px !important;">&#8377;</td>
					<td class="alignRight"><?php echo $round_off ?></td>
				</tr>
			<?php } ?>
			...
			<?php if ($tot_sales_amt > 0) { ?>
				...
				<tr style="font-weight: bold">
										<td colspan="5"></td>
					<td class="alignRight" colspan="2" style="white-space:nowrap;">Net Amount</td>
					<td class="alignRight" style="font-size:15px !important;">&#8377;</td>
				...
				<div class="table-responsive">
					...
					<table id="pp" class="table text-center">
						...
						<tr>
												...
												$credit_collection_details = $billing['previous_credit_collections'];
												foreach ($credit_collection_details as $credit) {
													$credit_txt = "Credit collection Ref Bill No.";
													$collection_amount = $credit['credit_disc_amt'] - $credit['advance_deposit'] + $credit['old_metal_amount'] + $credit['chit_amount'] + $credit['payment_amount'] + $credit['advance_adjusted'];
													$total_collection_amount += $collection_amount;
												}
												?>

												<td><?php echo 'Received with thanks from Mr./Ms.' . $billing['customer_name'] . ' Towards Credit Bill No : ' . $billing['credit_coll_refno']. ' Dated :' . (($billing['bill_date'])); ?></td>
												<td class="alignRight"><?php echo moneyFormatIndia(number_format($collection_amount, 2, '.', '')); ?></td>
						</tr>
						<tr>
							<td colspan="2">
								<hr class="item_details">
...
<?php }
	if (sizeof($payment['pay_details']) > 0) {
		...
		foreach ($payment['pay_details'] as $items) {
			...
			if ($items['payment_mode'] == 'NB' && $items['transfer_type'] == 'TPT') {
				$net_banking_amt += $items['payment_amount'];
				$tpt_amt += $items['payment_amount'];
			}
		}
	} ?>
...
<?php
if ($cash_amt > 0 || $ord_adj_amt > 0 || $chit_adj > 0 || $chq_amt > 0 || $card_amt > 0 || $upi_amt > 0 || $rtgs_amt > 0 || $imps_amt > 0 || $adv_adj > 0 || $gift_amount > 0 || $billing['advance_deposit'] > 0 || $neft_amt > 0 || $tpt_amt > 0 || $due_amount > 0 || $adj_amt > 0 || $billing['adv_adj_amt'] > 0) { ?>
	...
	<table id="pp" class="table" style="font-size: 12px;">
		...
		<thead style="text-transform:uppercase; visibility:hidden;">
			<tr>
				...
				<th colspan="2" class="table_heading textOverflowHidden" style="width:<?php echo sizeof($est_other_item['old_matel_details']) > 0 || sizeof($est_other_item['return_details']) > 0 || sizeof($est_other_item['order_details']) > 0 ? '34%' : '39%' ?>; text-align:left;"> </th>
				<!-- <th class="table_heading alignRight" style="width: 8%;"></th> -->
				<th class="table_heading alignRight" style="width: 5%;"></th>
				<th class="table_heading alignRight" style="width: 10%;"></th>
				<th class="table_heading alignRight" style="width: 10%;"></th>
				<th class="table_heading alignRight" style="width: 11%;"></th>
				<th class="table_heading alignRight" style="width: 10%;"></th>
				<th class="table_heading alignRight" style="width: 11%;"></th>
			</tr>
		</thead>
		...
		<?php if ($chit_adj != 0 && ($billing['bill_type'] != 10)) { ?>
			<tr>
				<td colspan="5"> </td>
				<td colspan="2" class="alignRight">CHIT ADJ</td>
				<td class="alignRight" style="font-size:15px !important;">&#8377;</td>
				<td class="alignRight"><?php echo moneyFormatIndia(number_format(round($chit_adj + $scheme_benefit), 2, '.', '')); ?></td>
			</tr>
			<tr>
									<td colspan="5"></td>
									<td colspan="2" class="alignRight">Balance Amount</td>
									<td class="alignRight" style="font-size:15px !important;">&#8377;</td>
									<td class="alignRight"><?php echo moneyFormatIndia(number_format(round($tot_sales_amt + $billing['handling_charges'] - $pur_total_amt - $total_return + $round_off - ($chit_adj + $scheme_benefit)), 2, '.', '')); ?></td>
								</tr>
			<tr>
				<td colspan="8"></td>
				<td>
		...
		<?php if ($ord_adj_amt > 0) { ?>
			<tr>
				<td colspan="4"></td>
									<td colspan="3" class="alignRight">ORDER ADVANCE ADJ</td>
									<td class="alignRight" style="font-size:15px !important;">&#8377;</td>
									<td class="alignRight"><?php echo moneyFormatIndia(number_format($ord_adj_amt, 2, '.', '')); ?></td>
			</tr>
		<?php } ?>
		<?php if ($billing['adv_adj_amt'] > 0) { ?>
			<tr>
				<td colspan="4"></td>
									<td colspan="3" class="alignRight">ADVANCE ADJ</td>
									<td class="alignRight" style="font-size:15px !important;">&#8377;</td>
				<!-- <th class="alignRight"><?php echo moneyFormatIndia(number_format(($billing['adv_adj_amt'] > 0 && $adj_amt > 0 && $billing['adv_adj_amt'] != $adj_amt) ? ($billing['adv_adj_amt'] + $adj_amt) : (($billing['adv_adj_amt'] > 0) ? $billing['adv_adj_amt'] : $adj_amt), 2, '.', '')); ?></th> -->
									<td class="alignRight"><?php echo moneyFormatIndia(number_format($billing['adv_adj_amt'], 2, '.', '')); ?></td>
			</tr>
		<?php } ?>
		<?php if ($chq_amt > 0) { ?>
				...
				if ($chq['payment_mode'] == 'CHQ') { ?>
					<tr>
						<td colspan="6"><?php echo 'Chq No: <strong>' . $chq['cheque_no'] . '</strong> / <strong>' . $chq['payment_ref_number'] . '</strong> Date: <strong>' . $chq['cheque_date'] . '</strong>'; ?></td>
											<td colspan="1" class="alignRight">CHEQUE</td>
											<td class="alignRight" style="font-size:15px !important;">&#8377;</td>
											<td class="alignRight"><?php echo moneyFormatIndia(number_format($chq['payment_amount'], 2, '.', '')); ?></td>
					</tr>
		<?php }
			}
		} ?>
					...
					<tr>
						<td colspan="6">
							...
							?>
											...
											<td colspan="1" class="alignRight">CARD</td>
											<td class="alignRight" style="font-size:15px !important;">&#8377;</td>
					...
					<tr>
						<td colspan="6">
							...
							?>
											...
											<td colspan="1" class="alignRight">RTGS</td>
					<td class="alignRight" style="font-size:15px !important;">&#8377;</td>
					<td class="alignRight"><?php echo moneyFormatIndia(number_format($rtgs['payment_amount'], 2, '.', '')); ?></td>
					</tr>
		<?php }
			}
		} ?>
					...
					<tr>
						<td colspan="6">
							...
							?>
											...
											<td colspan="1" class="alignRight">IMPS
							</td>
					<td class="alignRight" style="font-size:15px !important;">&#8377;</td>
					<td class="alignRight"><?php echo moneyFormatIndia(number_format($imps['payment_amount'], 2, '.', '')); ?></td>
					</tr>
		<?php }
			}
		} ?>
		...
		<?php if ($neft_amt > 0) { ?>
			<?php foreach ($payment['pay_details'] as $neft) {
				if ($neft['payment_mode'] == 'NB' && $neft['transfer_type'] == 'NEFT') { ?>
					...
					<td colspan="1" class="alignRight">NEFT</td>
					<td class="alignRight" style="font-size:15px !important;">&#8377;</td>
					<td class="alignRight"><?php echo moneyFormatIndia(number_format($neft['payment_amount'], 2, '.', '')); ?></td>
					</tr>
		<?php }
			}
		} ?>
		...
		<?php if ($tpt_amt > 0) { ?>
			<?php foreach ($payment['pay_details'] as $tpt) {
				if ($tpt['payment_mode'] == 'NB' && $tpt['transfer_type'] == 'TPT') { ?>
					<tr>
						<td colspan="6">
							<?php
							$details = [
								!empty($tpt['device_name']) ? $tpt['device_name'] : null,
								!empty($tpt['payment_ref_number']) ? 'Appr code: <strong>' . $tpt['payment_ref_number'] . '</strong>' : null,
								!empty($tpt['net_banking_date']) ? 'Date: <strong>' . $tpt['net_banking_date'] . '</strong>' : null
							];
					...
					<td colspan="1" class="alignRight">TPT</td>
					<td class="alignRight" style="font-size:15px !important;">&#8377;</td>
					<td class="alignRight"><?php echo moneyFormatIndia(number_format($tpt['payment_amount'], 2, '.', '')); ?></td>
					</tr>
		<?php }
			}
		} ?>
		...
		<?php if ($upi_amt > 0) { ?>
			<?php foreach ($payment['pay_details'] as $upi) {
				if ($upi['payment_mode'] == 'NB' && $upi['transfer_type'] == 'UPI') { ?>
					...
					<td colspan="1" class="alignRight">UPI</td>
					<td class="alignRight" style="font-size:15px !important;">&#8377;</td>
					<td class="alignRight"><?php echo moneyFormatIndia(number_format($upi['payment_amount'], 2, '.', '')); ?></td>
					</tr>
		<?php }
			}
		} ?>
		...
		<?php if ($adv_adj > 0) { ?>
			<tr>
				<td colspan="5"></td>
				<th colspan="2" class="alignRight"><?php echo ((($billing['bill_type'] == 1 || $billing['bill_type'] == 2 || $billing['bill_type'] == 3 || $billing['bill_type'] == 7 || $billing['bill_type'] == 5) && $billing['is_eda'] == 2) ? "ADVANCE PROFORMA" : "ADVANCE ADJ"); ?></th>
				<th class="alignRight" style="font-size:15px !important;">&#8377;</th>
		...
		<?php if ($bouns_amt != 0) { ?>
			<tr>
				<td colspan="5"></td>
				<td colspan="2" class="alignRight">BONUS</td>
				<td class="alignRight" style="font-size:15px !important;">&#8377;</td>
				<td class="alignRight"><?php echo moneyFormatIndia(number_format($bouns_amt, 2, '.', '')); ?></td>
			</tr>
		<?php } ?>
		...
		<?php if ($gift_amount != 0) { ?>
			<tr>
				<td colspan="5"></td>
				<td colspan="2" class="alignRight">GIFT UTILIZED</td>
				<td class="alignRight" style="font-size:15px !important;">&#8377;</td>
				<td class="alignRight"><?php echo moneyFormatIndia(number_format($gift_amount, 2, '.', '')); ?></td>
			</tr>
		<?php } ?>
		...
		<?php if ($billing['credit_disc_amt'] != 0) { ?>
			<tr>
				...
				<td class="alignRight" style="font-size:15px !important;">&#8377;</td>
				<td class="alignRight"><?php echo moneyFormatIndia(number_format($billing['credit_disc_amt'], 2, '.', '')); ?></td>
			</tr>
		<?php } ?>

		<?php if ($billing['advance_deposit'] != 0) { ?>
			<tr>
				<td colspan="5" style=> <?php echo (($billing['bill_type'] == 2 || $billing['bill_type'] == 3 || $billing['bill_type'] == 4 || $billing['bill_type'] == 7 || $billing['bill_type'] == 10) && $billing['make_as_advance'] == 1 ? ('Adv Receipt No : <strong>' . $billing['adv_bill_no'] . '</strong> / Date: <strong>' . $billing['bill_date'] . '</strong>') : ''); ?></td>
				<td colspan="2" class="alignRight">Advance</td>
				<td class="alignRight" style="font-size:15px !important;">&#8377;</td>
				<td class="alignRight"><?php echo moneyFormatIndia(number_format($billing['advance_deposit'], 2, '.', '')) ?></td>
			</tr>
		<?php } ?>
		...
		<?php if ($cash_amt > 0) { ?>
			<tr>
				<td colspan="5"></td>
				<td colspan="2" class="alignRight">Cash Received</td>
				<td class="alignRight">&#8377;</td>
	...
	<?php if ($due_amount != 0 && $due_amount > 0 && $billing['bill_type'] != 8) {
		$chit_utilized_amt = 0; ?>
		<?php if ((sizeof($est_other_item['chit_details']) > 0) && $billing['bill_type'] == 8) {

			foreach ($est_other_item['chit_details'] as $chit) {
				$chit_utilized_amt += $chit['utilized_amt'];
			}
		} ?>
		<?php $due_amt = $due_amount - $chit_utilized_amt - $billing['tot_adv_received'] ?>
		<?php if ($due_amt > 0) { ?>
			<tr>
				<td colspan="4"></td>
	...
	<table id="pp" class="pay_mode_totals table text-center" style=" font-size: 12px;">
		...
		<?php if ($chq_amt < 0) { ?>
			<?php foreach ($payment['pay_details'] as $chq) {
				if ($chq['payment_mode'] == 'CHQ') { ?>
					<tr>
						<td colspan="6"> <?php echo 'Chq No: <strong>' . $chq['cheque_no'] . '</strong>/  ' . $chq['payment_ref_number'] . 'Date: <strong>' . $chq['cheque_date'] .  '</strong>'; ?></td>
						<td colspan="1" class="alignRight">CHEQUE</td>
						<td class="alignRight" style="font-size:15px !important;">&#8377;</td>
						<td class="alignRight"><?php echo moneyFormatIndia(number_format($chq['payment_amount'], 2, '.', '')); ?></td>
					</tr>
		...
		<?php if ($rtgs_amt < 0) { ?>
			<?php foreach ($payment['pay_details'] as $rtgs) {
				if ($rtgs['payment_mode'] == 'NB' && $rtgs['transfer_type'] == 'RTGS') { ?>
					<tr>
						<!-- <td colspan="6"> <?php echo $rtgs['device_name'] . '/ Appr code: <strong>' . $rtgs['payment_ref_number'] . '</strong>' . '/' . 'Date: <strong>' . $rtgs['net_banking_date'] . '</strong>'; ?></td> -->
						<td colspan="6">
							<?php
							$details = [
								!empty($rtgs['device_name']) ? $rtgs['device_name'] : null,
		...
		<?php if ($imps_amt < 0) { ?>
			<?php foreach ($payment['pay_details'] as $imps) {
				if ($imps['payment_mode'] == 'NB' && $imps['transfer_type'] == 'IMPS') { ?>
					<tr>
						<td colspan="6"> <?php echo $imps['device_name'] . '/ Appr code: <strong>' . $imps['payment_ref_number'] . '</strong>' . '/' . 'Date: <strong>' . $imps['net_banking_date'] . '</strong>'; ?></td>
						<td colspan="1" class="alignRight">IMPS</td>
						<td class="alignRight" style="font-size:15px !important;">&#8377;</td>
						<td class="alignRight"><?php echo moneyFormatIndia(number_format($imps['payment_amount'], 2, '.', '')); ?></td>
					</tr>
		<?php }
		...
		<?php if ($upi_amt < 0) { ?>
			<?php foreach ($payment['pay_details'] as $upi) {
				if ($upi['payment_mode'] == 'NB' && $upi['transfer_type'] == 'UPI') { ?>
					<tr>
						<td colspan="6"> <?php echo $upi['device_name'] . '/ Appr code: <strong>' . $upi['payment_ref_number'] . '</strong>' . '/' . 'Date: <strong>' . $upi['net_banking_date'] . '</strong>'; ?></td>
						<td colspan="1" class="alignRight">UPI</td>
						<td class="alignRight" style="font-size:15px !important;">&#8377;</td>
						<td class="alignRight"><?php echo moneyFormatIndia(number_format($upi['payment_amount'], 2, '.', '')); ?></td>
					</tr>
		...
		<?php if ($cash_amt < 0) { ?>
			<tr>
				<td colspan="5"></td>
				<td colspan="2" class="alignRight"><?php echo ((($billing['bill_type'] == 1 || $billing['bill_type'] == 2 || $billing['bill_type'] == 3 || $billing['bill_type'] == 7 || $billing['bill_type'] == 5 || $billing['bill_type'] == 4) && $billing['is_eda'] == 2) ? 'Refund Payable' : 'Cash Paid'); ?></td>
				<td class="alignRight" style="font-size:15px !important;">&#8377;</td>
				<td class="alignRight"><?php echo moneyFormatIndia(number_format(($cash_amt), 2, '.', '')); ?></td>
			</tr>
		<?php } ?>
...
if (sizeof($get_other_adv_details) > 0 || $od_total_price > 0) {
	...
	$first_rate = $rate_new;
	$od_balance = $balance_amt - $total_amt - $billing['adv_adj_amt'];
	$od_metal_balance = round(($od_balance / $first_rate), 3);

	if ($est_other_item['advance_details'] > 0) {
		$cus_due_date = isset($est_other_item['advance_details'][0]['cus_due_date']) ? "DD(" . $est_other_item['advance_details'][0]['cus_due_date'] . ")" : '';
		$cus_ord_rate = (isset($est_other_item['advance_details'][0]['cus_due_date']) && $est_other_item['advance_details'][0]['rate_type'] == 1) ? 'Fixed(' . $est_other_item['order_details'][0]['rate_per_gram'] . ') - ' : 'Unfixed - ';
	}
?>
	<table>
		<tr>
		...
		<?php } else { ?>
			<tr style="font-weight: bold;">
				<td colspan="3">
					Order - <?php echo $cus_ord_rate . $cus_due_date; ?>
				</td>
	...
	<div class="col-xs-6">
		<div class="table-responsive">
			<table id="pp" class="table text-center">
				<tr>
					<td width="2%;">S.No</td>
					<td width="8%;">Ref No</td>
					<td width= "5%">Amount</td>
					<td width="25%;">Saved Wt</td>
				</tr>
				<tr>
					<td>
						<hr class="item_dashed" style="width:850% !important;">
					</td>
				</tr>
				<?php
				$i = 1;
				foreach ($est_other_item['chit_details'] as $chit) { ?>
					<tr>
						...
						<td><?php echo $chit['closing_weight'] ; ?></td>
					</tr>
				<?php $i++;
					$sheme_close += $chit['utilized_amt'];
					$scheme_wt += $chit['closing_weight'];
				}
				if ($scheme_benefit > 0) {
				?>
					<tr>
				...
				<tr>
					...
					<!-- <td><?php echo moneyFormatIndia($scheme_wt); ?></td> -->
				</tr>
			</table>
		</div>
	</div>
			...
			<table id="pp" class="table text-center" style="width:45%;">
				...
				<tbody>
					<tr>
						...
						<td><?php echo number_format($val['adjuseted_amt'] + $val['refund_amt'], 2, '.', ''); ?></td>
...
<?php if ($billing['remark'] != '' && strlen($billing['remark']) > 1 || ($items['is_delivered'] == 0 && $billing['is_to_be'] == 1)) { ?>
	<div style="font-weight:bold;">
		REMARK &nbsp;:<?php echo ($items['is_delivered'] == 0 && $billing['is_to_be'] == 1 ? ' *Jewel not delivered. ' : '') . ($billing['remark'] != '' ? $billing['remark'] : ''); ?>
		<br>
		<br>
	</div>
<?php } ?>
...
<?php } ?>
	<br>
<?php if ($billing['attender_name'] != '') { ?>
	<div style="font-weight:bold;">
		<?php echo 'Billed Emp : ' . $billing['attender_name'] . '/' . $billing['bill_emp_code'] . ($billing['counter_name'] != '' ? ' -&nbsp;' . $billing['counter_name'] : '') ?>
	</div>
<?php } ?>

	<div>
		<?php
			if (sizeof($billing['previous_credit_collections']) > 0) { 
				...
				<br>
				<br>
				<table id="credit_table" style="width:100%; font-size:10px">
					<tr style="font-weight: bold;">
						<td colspan="5" style="font-weight: bold; font-size:10px; padding-bottom: 5px">Credit Collection Details :</td>
					</tr>
					<tr>
						<td colspan="2">Opening Credit <span>Bill No</span> <?php echo  $billing['ref_numbers']['sales_ref_no'] . " Dated : " . date("d-m-Y", strtotime($billing['ref_numbers']['ref_date'])) ?></td>
						<td colspan="3"></td>
						<td></td>
						<td class="alignRight">Rs.</td>
						<td style="width:3%;"></td>
						<td class="alignRight"><?php echo number_format($billing['due_amount'], 2, '.', ''); ?></td>
					</tr>
					<?php
					$total_collection_amount = 0;
					$credit_collection_details = $billing['previous_credit_collections'];
					foreach ($credit_collection_details as $credit) {
						...
						$total_collection_amount += $collection_amount;
					?>
						<tr style="padding-top:40px !important;">
							<td colspan="5"><?php echo $credit_txt . $credit['credit_coll_refno'] . " Dated : " . date("d-m-Y", strtotime($credit['bill_date'])) ?></td>
							<td class="alignRight"></td>
							<td class="alignRight" style="width:10%;">Rs.</td>
							<td></td>
							<td class="alignRight"><?php echo number_format($collection_amount, 2, '.', ''); ?></td>
						</tr>
					<?php
					}
					?>
					...
					<tr>
						<td colspan="2"><?php  echo ($billing['credit_due_date'] > 0) ? "Balance Credit Amount (" . $billing['credit_due_date'] . " )" : "Balance Credit Amount " . $billing['credit_due_date'];?></td>
						<td colspan="4"></td>
						<td class="alignRight" style="width:10%;">Rs.</td>
						<td></td>
						<td class="alignRight"><?php echo number_format($billing['due_amount'] - $total_collection_amount, 2, '.', ''); ?></td>
					</tr>
					<tr>
						<td colspan="7"></td>
						<td colspan="2">
...
<div class="footer">
		...
		<table style="width:100%; border-collapse:collapse; font-weight:bold; margin-top:20px; margin-bottom: 50px;">
			<tr>
				<td style="font-size:16px; text-align:left; width:50%; padding:10px 0; border:none;">Customer Signature</td>
				<td style="font-size:16px; text-align:right; width:50%; padding:10px 0; border:none;">For <?php echo $billing['branch_name']; ?></td>
			</tr>
		</table>
	...
	<?php if ($is_eda == 2) { ?>
		<div style="font-size:11px; width:98%;">
			<p>*GST values applicable. E.&O.E</p>
		</div>
	<?php } ?>
