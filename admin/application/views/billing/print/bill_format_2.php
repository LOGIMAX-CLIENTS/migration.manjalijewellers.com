	...
	<style>
		...
		* {
		...
		@page {
			size: A4;
			margin-top: 60mm;
			margin-bottom: <?php echo $is_softcopy ? '15mm' : '30mm'; ?>;
			margin-left: 25px;
			margin-right: 25px;
		}
		...
		.bg {
			...
			left: -10px;
			right: -10px;
			background: url('<?php echo $background_image; ?>') center center;
			background-size: cover;
			z-index: -1;
		}
...
<body>
	...
	<div class="PDFReceipt">
		...
		if (!function_exists('removeLastWordAs')) {
...
<?php if (sizeof($receiptDetails) > 0) {
					...
					<td>
						<div class="content-block">
							...
							<div style="width:100%;" class="new_tax">
								...
								<!-- <span style="text-align:center;font-size: 12px;text-transform:none;"> <?php //echo ($billing['is_today'] == 1 ? '' : '( Duplicate Copy )') ?> </span> -->
							</div>
							<!-- Replace flexbox wrapper with table layout for DomPDF compatibility -->
							<table class="wrapper-table">
								<tr>
									<td class="col-40" id="a1">
									...
									<div>
										<table style="font-weight:bold; width:100%; border-collapse:collapse;">
											...
											<tr>
												<td style="padding:2px;"><label>Gold 14-KT</label></td>
												<td style="padding:2px;">:</td>
												<td style="padding:2px;"><?php echo  number_format($billing['goldrate_14ct'], 2, '.', '') . '/Gm'; ?></td>
											</tr>
											<tr>
			...
			<tbody>
				<tr>
											...
											<?php if (sizeof($est_other_item['item_details']) > 0) { ?>
												...
												<div class="col-xs-12">
													<div class="table-responsive">
														<!-- <table id="pp" style="width:99%; border-collapse:collapse; font-size:10px;">
															<tr>
																<td colspan="9">
														...
														<table id="pp" style="width:99%; border-collapse:collapse; font-size:10px;">
															<thead style="text-transform:uppercase;font-size:10px;">
																...
																<tr>
																	...
																	<th class="table_heading alignLeft" style="width: 28%; text-align:left; padding:3px; border:none;">Description</th>
																	...
																	<th class="table_heading alignRight" style="width: 7%; text-align:right; padding:3px; border:none;">VA</th>
																	<th class="table_heading alignRight" style="width: 7%; text-align:right; padding:3px; border:none;">MC</th>
															...
															<tbody>
																...
																foreach ($est_other_item['item_details'] as $items) {
																	...
																	if (count($items['stone_details']) > 0) {
																		foreach ($items['stone_details'] as $stoneItems) {
																			...
																			if($stoneItems['stone_type'] == 1 && $stoneItems['uom_id'] == 6) {
																				$total_dia_wt += $stoneItems['wt'];
																			}
																		}
																	}
																	...
																	$tot_item_discount += $items['bill_discount'];

																	foreach ($items['other_metal_details'] as $other_metal_details){
																		$other_metal_amount += $other_metal_details['tag_other_itm_amount'];
																	}
																	if($settings['bill_discount_type'] == 2){
																	$taxable_amt    += $items['item_cost'] - $items['item_total_tax'];
																		$item_taxable   = number_format((float)$items['item_cost'] - $items['item_total_tax'], 2, '.', '');
																	}else{																	
																		$taxable_amt    += $items['item_cost'] + $items['bill_discount'] - $items['item_total_tax'];
																		$item_taxable   = number_format((float)$items['item_cost'] + $items['bill_discount'] - $items['item_total_tax'], 2, '.', '');
																		// print_r($items['item_cost']);exit;
																	}
																...
																?>
																	...
																	<tr>
																		...
																		<td style="text-align:left; padding:3px; border:none; width:28%; white-space:nowrap; overflow:hidden;"><?php echo $items['product_name']; ?><?php echo ' - ' . $items['design_name']; ?></td>
																		<td style="text-align:right; padding:3px; border:none; width:8%;"><?php echo $items['hsn_code']; ?></td>
																		<td style="text-align:right; padding:3px; border:none; width:5%;"><?php echo $items['piece']; ?></td>
																		<td style="text-align:right; padding:3px; border:none; width:9%;"><?php echo $items['gross_wt'] . ($items['pro_uom'] != '' ? '-' . $items['pro_uom'] : ''); ?></td>
																		<td style="text-align:right; padding:3px; border:none; width:9%;"><?php echo $items['net_wt'] . ($items['pro_uom'] != '' ? '-' . $items['pro_uom'] : '') ?></td>
																		<td style="text-align:right; padding:3px; border:none; width:7%;"><?php echo $item_wastge_wt > 0 ? moneyFormatIndia(number_format($item_wastge_wt, 3, '.', '')) : ''; ?></td>
																		<td style="text-align:right; padding:3px; border:none; width:7%;"><?php echo $mc > 0 ? moneyFormatIndia($mc) : ''; ?></td>
																		<td style="text-align:right; padding:3px; border:none; width:10%;"><?php echo moneyFormatIndia(number_format($items['rate_per_grm'], 0, '.', '')); ?></td>
																		<td style="text-align:right; padding:3px; border:none; width:12%;"><?php echo moneyFormatIndia(number_format((float)($item_taxable > 0 ? ($item_taxable - $other_metal_amount) : 0), 0, '.', '')); ?></td>
																	</tr>
																	<!-- <tr>
															<td></td>
															...
															<td colspan="6"></td>
																	...
																	?>
																		...
																		if (count($items['stone_details']) > 0 && !empty($items['cert_no']) && $stoneItems['uom_id'] == 6) {
																		?>
																			<tr class="certificate">
																				<td></td>
																				<td colspan="9">
																					Certificate No: <?php echo $items['cert_no']; ?>
																				</td>
																			</tr>
																		<?php } 
															...
															<tr style="font-weight: bold">
																...
																<td style="padding:3px; border:none; width:28%;"><?php if ($total_dia_wt > 0) { ?>Total Diamond <?php echo number_format($total_dia_wt, 3, '.', '').' CTS'; } ?></td>
																<td style="padding:3px; border:none; width:8%;"></td>
																<td style="text-align:right; padding:3px; border:none; width:5%;"><?php echo $pieces; ?></td>
																<td style="text-align:right; padding:3px; border:none; width:9%;"><?php echo number_format($gross_wt, 3, '.', ''); ?></td>
																<td style="text-align:right; padding:3px; border:none; width:9%;"><?php echo number_format($net_wt, 3, '.', ''); ?></td>
																<td style="padding:3px; border:none; width:7%;"></td>
																<td style="padding:3px; border:none; width:7%;"></td>
																<td style="padding:3px; border:none; width:10%;"></td>
																<td style="text-align:right; padding:3px; border:none; width:12%;"><?php echo moneyFormatIndia(number_format((float)($taxable_amt), 0, '.', '')); ?></td>
															</tr>
															<tr>
																<td colspan="10">
																	<hr class="item_dashed">
															...
															<?php if($settings['bill_discount_type'] == 1){
															if ($tot_item_discount > 0) { ?>
																<tr>
																	<td colspan="6"></td>
																	<td colspan="2" class="alignRight">DISCOUNT</td>
																	<td class="alignRight" style="font-size:12px;">Rs</td>
																	<td class="alignRight"><?php echo moneyFormatIndia(number_format((float)($tot_item_discount), 0, '.', '')); ?></td>
																</tr>
															<?php } }?>
															...
															<?php if ($taxable_amt > 0) { ?>
																<tr>
																	...
																	<td style="text-align:right; padding:3px; border:none;">SUB TOTAL</td>
																	<td style="text-align:right; padding:3px; border:none; font-size:12px;">Rs</td>
																	<td class="alignRight"><?php echo $settings['bill_discount_type'] == 1 ? moneyFormatIndia(number_format((float)($taxable_amt - $tot_item_discount), 0, '.', '')) : moneyFormatIndia(number_format((float)($taxable_amt), 0, '.', '')) ; ?></td>
																</tr>
															<?php } ?>
															<?php if ($total_sgst > 0) { ?>
																<tr>
																	<td colspan="7" style="border:none;"></td>
																	<td style="text-align:right; padding:3px; border:none;">SGST<?php echo (sizeof($est_other_item['tax_details']) == 1 ? '(' . ($est_other_item['item_details'][0]['tax_percentage'] / 2) . '%)' : '') ?></td>
																	<td style="text-align:right; padding:3px; border:none; font-size:12px;">Rs</td>
																	<td style="text-align:right; padding:3px; border:none;"><?php echo moneyFormatIndia(number_format((float)($total_sgst), 2, '.', '')); ?></td>
																</tr>
															<?php } ?>
															...
															<?php if ($total_cgst > 0) { ?>
																<tr>
																	<td colspan="7" style="border:none;"></td>
																	<td style="text-align:right; padding:3px; border:none;">CGST <?php echo (sizeof($est_other_item['tax_details']) == 1 ? '(' . ($est_other_item['item_details'][0]['tax_percentage'] / 2) . '%)' : '') ?></td>
																	<td style="text-align:right; padding:3px; border:none; font-size:12px;">Rs</td>
																	<td style="text-align:right; padding:3px; border:none;"><?php echo moneyFormatIndia(number_format((float)($total_cgst), 2, '.', '')); ?></td>
																</tr>
															<?php } ?>
															...
															<?php if ($total_igst > 0) { ?>
																<tr>
																	<td colspan="7" style="border:none;"></td>
																	<td style="text-align:right; padding:3px; border:none;">IGST <?php echo (sizeof($est_other_item['tax_details']) == 1 ? '(' . ($est_other_item['item_details'][0]['tax_percentage']) . '%)' : '') ?></td>
																	<td style="text-align:right; padding:3px; border:none; font-size:12px;">Rs</td>
																	<td style="text-align:right; padding:3px; border:none;"><?php echo moneyFormatIndia(number_format((float)($total_igst), 2, '.', '')); ?></td>
																</tr>
															<?php } ?>
															...
															if ((sizeof($est_other_item['return_details']) == 0) && ((sizeof($est_other_item['old_matel_details']) == 0)) && ($billing['round_off_amt'] != 0)) { ?>
																...
																<tr style="font-weight: bold;">
																	<td colspan="7" style="border:none;"></td>
																	<td style="text-align:right; padding:3px; border:none; font-size: 12px;">TOTAL</td>
																	<td style="text-align:right; padding:3px; border:none; font-size:12px;">Rs</td>
																	<td style="text-align:right; padding:3px; border:none; font-size: 12px;"><?php echo moneyFormatIndia(number_format($tot_sales_amt + $billing['handling_charges'] + $billing['round_off_amt'] - $scheme_benefit, 0, '.', '')); ?></td>
																</tr>
																<tr>
										...
										<table id="pp" style="width:99%; border-collapse:collapse; font-size:10px;">
											<thead style="text-transform:uppercase;font-size:10px;">
												<tr>
													...
													<th class="table_heading alignRight" style="width: 9%; text-align:right; padding:3px; border:none;">NET.WT</th>
													<th class="table_heading alignRight" style="width: 7%; text-align:right; padding:3px; border:none;">VA</th>
													<th class="table_heading alignRight" style="width: 7%; text-align:right; padding:3px; border:none;">MC/GM</th>
													<th class="table_heading alignRight" style="width: 10%; text-align:right; padding:3px; border:none;">Rate</th>
													<th class="table_heading alignRight" style="width: 12%; text-align:right; padding:3px; border:none;">Amount</th>
												</tr>
											</thead>
											...
											<div class="table-responsive">
												<table id="pp" class="table text-center">
													...
													<tr>
														...
														<td width="1%;" style="font-size:15px !important;" >Rs</td>
											...
											<div class="table-responsive">
												...
												<table id="pp" class="table text-center">
													...
													<tr style="text-transform:uppercase;font-size:12px;">
														...
														<th class="table_heading alignRight" style="width: 10%;">VA</th>
										...
										<table id="pp" class="table text-center">
											...
											<?php if ($bill_discount > 0) { ?>
												<tr>
													<td colspan="3"></td>
													<td width="">LESS DISC</td>
													<td style="text-align:right; font-size:15px !important;">Rs</td>
											...
											<?php if ($taxable_amt > 0) { ?>
												<tr>
													<td colspan="4"></td>
													<td width="">SUB TOTAL</td>
													<td style="font-size:15px !important; text-align:right;">Rs</td>
							...
							<div class="row">
								...
								<div class="col-xs-12">
									<div class="table-responsive">
										...
										<table id="pp" class="table text-center" style="width: 99%; border-collapse: collapse;">
											<!--	<thead> -->
					...
					if($billing['bill_type'] == 1 || $billing['bill_type'] == 9){
						...
						<table id="pp" class="table" style="width: 99%; border-collapse: collapse; font-size: 12px;">
							...
							<?php if ($chit_adj != 0 && ($billing['bill_type'] != 10)) { ?>
								<tr>
									...
									<th class="alignRight">Rs</th>
									<th class="alignRight"><?php echo moneyFormatIndia(number_format(round($chit_adj + $scheme_benefit), 0, '.', '')); ?></th>
								</tr>
								<tr>
									<td colspan="8"></td>
									<td>
								...
								<tr>
									...
									<th class="alignRight">Rs</th>
									<th class="alignRight"><?php echo moneyFormatIndia(number_format(round($tot_sales_amt + $billing['handling_charges'] - $pur_total_amt - $total_return + $round_off - ($chit_adj + $scheme_benefit)), 0, '.', '')); ?></th>
								</tr>
							<?php } ?>
							...
							<!-- <?php if ($ord_adj_amt != 0 || $billing['adv_adj_amt'] != 0) { ?>
								<tr>
									...
									<th class="alignRight">Rs</th>
									<th class="alignRight"><?php echo moneyFormatIndia(number_format($ord_adj_amt + $billing['adv_adj_amt'], 0, '.', '')); ?></th>
								</tr>
								<?php } ?> -->
							...
							<?php if ($billing['adv_adj_amt'] > 0) { ?>
								<tr>
									...
									<th class="alignRight">Rs</th>
									<!-- <th class="alignRight"><?php echo moneyFormatIndia(number_format(($billing['adv_adj_amt'] > 0 && $adj_amt > 0 && $billing['adv_adj_amt'] != $adj_amt ) ? ($billing['adv_adj_amt'] + $adj_amt) : (($billing['adv_adj_amt'] > 0) ? $billing['adv_adj_amt'] : $adj_amt) , 0, '.', '')); ?></th> -->
									<th class="alignRight"><?php echo moneyFormatIndia(number_format($billing['adv_adj_amt'], 0, '.', '')); ?></th>
								</tr>
							<?php } ?>
							<?php if ($chq_amt > 0) { ?>
								<?php foreach ($payment['pay_details'] as $chq) {
									if ($chq['payment_mode'] == 'CHQ') { ?>
										<tr>
											...
											<th class="alignRight">Rs</th>
											<th class="alignRight"><?php echo moneyFormatIndia(number_format($chq['payment_amount'], 0, '.', '')); ?></th>
										</tr>
							<?php }
								}
							} ?>
										...
										<tr>
											<td colspan="6">
												...
												$details = [
													...
													!empty($cardItem['card_date']) ? 'Card Date: <strong>' . $cardItem['card_date'] . '</strong>' : (!empty($cardItem['payment_date']) ? 'Date: <strong>' . $cardItem['payment_date'] . '</strong>' : null)
												];
											...
											<th class="alignRight">Rs</th>
											<th class="alignRight"><?php echo moneyFormatIndia(number_format($cardItem['payment_amount'], 0, '.', '')); ?></th>
										</tr>
							<?php }
								}
							} ?>
					...
					<th class="alignRight">Rs</th>
					<th class="alignRight"><?php echo moneyFormatIndia(number_format($rtgs['payment_amount'], 0, '.', '')); ?></th>
				</tr>
	<?php }
								}
							} ?>
		...
		<?php foreach ($payment['pay_details'] as $imps) {
				...
				<tr>
 									   ...
 									   ?>
											...
											<th colspan="1" class="alignRight">IMPS
					</th>
					<th class="alignRight">Rs</th>
					<th class="alignRight"><?php echo moneyFormatIndia(number_format($imps['payment_amount'], 0, '.', '')); ?></th>
				</tr>
	<?php }
							}
						} ?>
	...
	<?php if ($neft_amt > 0) { ?>
		<?php foreach ($payment['pay_details'] as $neft) {
				...
				<tr>
					...
					<th class="alignRight">Rs</th>
					<th class="alignRight"><?php echo moneyFormatIndia(number_format($neft['payment_amount'], 0, '.', '')); ?></th>
				</tr>
	<?php }
							}
						} ?>
	...
	<?php if ($upi_amt > 0) { ?>
		<?php foreach ($payment['pay_details'] as $upi) {
				...
				<td colspan="6">
					...
					<th class="alignRight">Rs</th>
					<th class="alignRight"><?php echo moneyFormatIndia(number_format($upi['payment_amount'], 0, '.', '')); ?></th>
				</tr>
	<?php }
							}
						} ?>
	...
	<?php if ($adv_adj > 0) { ?>
		<tr>
			...
			<th class="alignRight">Rs</th>
			<th class="alignRight"><?php echo moneyFormatIndia(number_format($adv_adj, 0, '.', '')); ?></th>
		</tr>
	<?php } ?>
	...
	<?php if ($bouns_amt != 0) { ?>
		<tr>
			...
			<th class="alignRight">Rs</th>
			<th class="alignRight"><?php echo moneyFormatIndia(number_format($bouns_amt, 0, '.', '')); ?></th>
		</tr>
	<?php } ?>
	...
	<?php if ($gift_amount != 0) { ?>
		<tr>
			...
			<th class="alignRight">Rs</th>
			<th class="alignRight"><?php echo moneyFormatIndia(number_format($gift_amount, 0, '.', '')); ?></th>
		</tr>
	<?php } ?>
	...
	<?php if ($billing['credit_disc_amt'] != 0) { ?>
		<tr>
			...
			<th class="alignRight" style="font-size:12px;">Rs</th>
			<th class="alignRight"><?php echo moneyFormatIndia(number_format($billing['credit_disc_amt'], 0, '.', '')); ?></th>
		</tr>
	<?php } ?>
	...
	<?php if ($billing['advance_deposit'] != 0) { ?>
		<tr>
			...
			<th class="alignRight">Rs</th>
			<th class="alignRight"><?php echo moneyFormatIndia(number_format($billing['advance_deposit'], 0, '.', '')) ?></th>
		</tr>
	<?php } ?>
	...
	<?php if ($cash_amt > 0) { ?>
		<tr>
			...
			<th class="alignRight">Rs</th>
			<th class="alignRight"><?php echo moneyFormatIndia(number_format($cash_amt, 0, '.', '')); ?></th>
		</tr>
	<?php } ?>
	...
	<?php if ($due_amount > 0) { ?>
		<tr>
			<td colspan="4"></td>
			<th colspan="3" class="alignRight">DUE AMOUNT<?php echo ($billing['credit_due_date'] != '' ? " (".$billing['credit_due_date'].")" : '') ?></th>
			<th class="alignRight">Rs</th>
...
if($billing['bill_type'] == 1 || $billing['bill_type'] == 9 ){
			...
			<div class="table-responsive">
				<table id="pp" class="table text-center" style="width: 100%; table-layout: fixed;">
					...
					<tr style="text-transform:uppercase;font-size:12px;">
						...
						<th style="text-align: right;">Rate Benefit</th>
					...
					foreach ($est_other_item['chit_details'] as $chit) { 
						...
						// Determine if scheme is weight-based or amount-based
						$is_weight = 1;
						if($chit['new_scheme_type'] == 0) {
							$is_weight = 0;
						} else if($chit['new_scheme_type'] == 3) {
						...
						} else if(in_array($chit['new_scheme_type'], [1, 2])) {
							$is_weight = 1;
						}

						if ($is_weight == 1 && $chit['closing_weight'] > 0) {
							$rate_per_gram = ($chit['rate_per_gram'] > 0 ? $chit['rate_per_gram'] : $billing['goldrate_22ct']);
							$closing_weight = number_format($chit['closing_weight'], 3, '.', '');
							$closing_amount = $chit['closing_amount'];
							...
							$scheme_benefit = number_format(max(0, $base_benefit), 0, '.', '');
						} else if ($is_weight == 0 && $chit['closing_amount'] > 0) {
							// Amount scheme benefit calculation - use closing_benefits from scheme_account
							$base_benefit = $chit['closing_benefits'];
	...
	<div>
		...
		if (sizeof($billing['previous_credit_collections']) > 0) { ?>
			<br>
			<br>
			<table id="credit_table" style="width:99%;font-weight: bold;">
				<tr style="font-weight: bold; font-size: 10px;">
					<td colspan="5" style="font-weight: bold; font-size: 10px; padding-bottom: 5px">Credit Collection Details :</td>
				</tr>
				<tr style="font-weight: bold; font-size: 10px;">
					<td colspan="2" style="font-weight: bold; font-size: 10px;">Opening Credit <span style="padding-left:15px">Ref Bill No.</span> <?php echo  $billing['ref_bill_no']; ?> <span style="padding-left:10px"> <?php echo "Dated : " . date("d-m-Y", strtotime($billing['ref_numbers']['ref_date'])) ?></span></td>
					<td colspan="3"></td>
					<td></td>
					<td class="alignRight">Rs.</td>
					<td style="width:3%;"></td>
				...
				<?php
					...
					$credit_collection_details = $billing['previous_credit_collections'];
					foreach ($credit_collection_details as $credit) {
						$credit_txt = "Credit Collection";
						$collection_amount = $credit['credit_disc_amt'] - $credit['advance_deposit'] + $credit['old_metal_amount']  + $credit['chit_amount'] + $credit['payment_amount'] + $credit['advance_adjusted'];
						$total_collection_amount += $collection_amount;
				?>
				<tr style="padding-top:40px !important; font-size: 10px;">
					<td colspan="5" style="font-size: 10px;"><?php echo $credit_txt; ?><span style="padding-left:10px">Ref Bill No. <?php echo $credit['invoice_no'];?> </span> <span style="padding-left:10px"> <?php echo "Dated : " . date("d-m-Y", strtotime($credit['bill_date'])) ?></span></td>
					<td class="alignRight"></td>
				...
				<tr style="font-weight: bold; font-size: 10px;">
					<td colspan="2" style="font-weight: bold; font-size: 10px;"><?php echo "Balance Credit Amount" ?></td>
					<td colspan="4"></td>
					<td class="alignRight" style="width:10%;">Rs.</td>
					<td></td>
					<td class="alignRight"><?php echo moneyFormatIndia(number_format($billing['due_amount'] - $total_collection_amount, 2, '.', '')); ?></td>
				</tr>
				<tr>
					<td colspan="7"></td>
					<td colspan="2">
	...
	<div class="footer">
		...
		<?php if (!$is_softcopy) { ?>
		<!-- <div style="font-size:11px; width:99%;">
