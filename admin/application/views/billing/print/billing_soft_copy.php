...
<body>
	...
	?>
        ...
        <!-- <div style="width:100%; text-align: right; height:60px;">
				<img src="<?php echo $billQR ;?>" alt="QRcode" style="height:60px; width:60px;">
			</div> -->
        <div style="width:100%; height: 150px;">
            <!-- <img src="<?php echo base_url();?>assets/img/billing/header.jpg" alt="header"
        ...
        <div class="wrapper">
            <div id="a1" class="column">
                ...
                <div>
                    ...
                    <label><?php echo (!empty($billing['title']) ? $billing['title'].'. ' : 'Mr/Mrs. '). $billing['customer_name']; ?></label><br>
                ...
                <div>
                    ...
                    <label><?php echo 'Name:&nbsp;&nbsp;' . $billing['transfer_details']['name']; ?></label><br>
                    <label><?php echo 'Address1:&nbsp;&nbsp;' . $billing['transfer_details']['address1']; ?></label><br>
                    ...
                    <label><?php echo '&nbsp;&nbsp;' . $billing['transfer_details']['state']; ?></label><br>
                    <label><?php echo 'GST:&nbsp;&nbsp;' . $billing['transfer_details']['gst_number']; ?></label>
                </div>
                <?php } ?>
            </div>
            ...
            <div id="a3" class="column">
                <div>
                    <table style="font-weight:bold;">
                        <tr>
                            <td style="width:40%;">
                                <label><?php echo ($billing['bill_type'] == 15 ? 'Ack No' : 'Invoice No'); ?></label>
                            </td>
        ...
        <div class="content-wrapper">
            <div class="box">
                <div class="box-body">
					...
					?>
                                ...
                                <div style="text-align:center;font-weight:bold;"><?php echo $title; ?></div>
                                <br>
                            ...
                            <div align="center">
                                <label><b>Order
                                        No.<?php echo $est_other_item['item_details'][0]['order_no']; ?></b></label>
                            </div>
                            <?php }
												?>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table id="pp" class="table">
                                        <thead style="text-transform:uppercase;font-size:12px;">
                                            ...
                                            <tr>
                                                <th class="table_heading alignCenter"
                                                    style="width: 5%; text-align:center;">S.No</th>
                                                <th class="table_heading textOverflowHidden"
                                                    style="width: 30%; text-align:left;">Description </th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:left;" class="textOverflowHidden">
                                                    <?php echo $items['product_name']; ?><?php echo ' - ' . $items['design_name']; ?>
                                                </td>
                                                <td class="alignRight"><?php echo $items['hsn_code']; ?></td>
                                                <td class="alignRight"><?php echo $items['piece']; ?></td>
                                                <td class="alignRight">
                                                    <?php echo $items['gross_wt'] . ($items['pro_uom'] != '' ? '-' . $items['pro_uom'] : ''); ?>
                                                </td>
                                                <td class="alignRight">
                                                    <?php echo $items['net_wt'] . ($items['pro_uom'] != '' ? '-' . $items['pro_uom'] : '') ?>
                                                </td>
                                                <!-- <td class="alignRight">
															<?php
																	if ($items['net_wt'] >= 1) {
                                                ...
                                                <td class="alignRight">
                                                    <?php echo $item_wastge_wt > 0 ? moneyFormatIndia(number_format($item_wastge_wt, 3, '.', '')) : ''; ?>
                                                </td>
                                                <td class="alignRight">
                                                    <?php echo $mc > 0 ? moneyFormatIndia(number_format($mc, 2, '.', '')) : ''; ?>
                                                </td>
                                                <td class="alignRight">
                                                    <?php echo moneyFormatIndia($items['rate_per_grm']); ?></td>
                                                <td class="alignRight">
                                                    <?php echo moneyFormatIndia(number_format((float)($item_taxable > 0 ? ($item_taxable) : 0), 2, '.', '')); ?>
                                                </td>
                                            </tr>
                                            <!-- <tr>
															<td></td>
                                            ...
                                            <tr style>
                                                ...
                                                <!-- <td></td> -->
                                                <td class="alignRight">
                                                    <?php echo $other_metal_details['tag_other_itm_grs_weight'] ?></td>

                                                <td class="alignRight">
                                                    <?php echo $other_metal_details['tag_other_itm_grs_weight'] ?></td>

                                                <td class="alignRight">
                                                    <?php echo $other_metal_details['tag_other_itm_wastage'] . '%' ?>
                                                </td>

                                                <td class="alignRight">
                                                    <?php echo moneyFormatIndia($other_metal_details['tag_other_itm_mc']) ?>
                                                </td>
                                                <td class="alignRight">
                                                    <?php echo moneyFormatIndia($other_metal_details['tag_other_itm_rate']) ?>
                                                </td>

                                                <td class="alignRight">
                                                    <?php echo moneyFormatIndia(number_format($other_metal_details['tag_other_itm_amount'], 2, '.', '')) ?>
                                                </td>
                                            ...
                                            <tr class="stones">
                                                ...
                                                <td colspan="4" class='textOverflowHidden stoneData'>
                                                    <?php echo $stoneItems['pieces'] . ' Pcs ' . $stoneItems['stone_name'] . ($stoneItems['amount'] > 0 ? ' ' . number_format($stoneItems['wt'], 3, '.', '') . ' ' . $stoneItems['uom_short_code'] . 'x' . moneyFormatIndia(number_format($stoneItems['rate_per_gram'], 2, '.', '')) . '=' . moneyFormatIndia(number_format((float)($stoneItems['amount']), 2, '.', '')) : ''); ?>
                                                </td>
                                                <?php } else if ($stoneItems['stone_cal_type'] == 2) { ?>
                                                <td colspan="4" class='textOverflowHidden stoneData'>
                                                    <?php echo number_format($stoneItems['wt'], 3, '.', '') . ' ' . $stoneItems['uom_short_code'] . ' ' . $stoneItems['stone_name'] . ($stoneItems['amount'] > 0 ? ' ' . $stoneItems['pieces'] . 'Pcs ' . 'x' . $stoneItems['rate_per_gram'] . '=' . moneyFormatIndia(number_format((float)($stoneItems['amount']), 2, '.', '')) : ''); ?>
                                                </td>
                                                <?php } ?>
                                            ...
                                            <tr>
                                                <td></td>
                                                <td colspan="2">
                                                    <?php echo $items['show_huid'] == 1 &&  $items['huid']   ? 'HUID: ' . $items['huid'] : ''; ?>
                                                </td>
                                                <td colspan="7"></td>
                                            </tr>
                                            <?php $i++;
                                        ...
                                        <tr class="total" style="font-weight: bold">
                                            ...
                                            <td class="alignRight"><?php echo number_format($gross_wt, 3, '.', ''); ?>
                                            </td>
                                            <td class="alignRight"><?php echo number_format($net_wt, 3, '.', ''); ?>
                                            </td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                            <td class="alignRight">
                                                <?php echo moneyFormatIndia(number_format((float)($taxable_amt), 2, '.', '')); ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="10">
                                        ...
                                        <tr>
                                            ...
                                            <td class="alignRight" style="font-size:15px !important;">Rs</td>
                                            <td class="alignRight">
                                                <?php echo moneyFormatIndia(number_format((float)($taxable_amt), 2, '.', '')); ?>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" class="alignRight">
                                                SGST<?php echo (sizeof($est_other_item['tax_details']) == 1 ? '(' . ($est_other_item['item_details'][0]['tax_percentage'] / 2) . '%)' : '') ?>
                                            </td>
                                            <td class="alignRight" style="font-size:15px !important;">Rs</td>
                                            <td class="alignRight">
                                                <?php echo moneyFormatIndia(number_format((float)($total_sgst), 2, '.', '')); ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                        ...
                                        <tr>
                                            <td colspan="6"></td>
                                            <td colspan="2" class="alignRight">CGST
                                                <?php echo (sizeof($est_other_item['tax_details']) == 1 ? '(' . ($est_other_item['item_details'][0]['tax_percentage'] / 2) . '%)' : '') ?>
                                            </td>
                                            <td class="alignRight" style="font-size:15px !important;">Rs</td>
                                            <td class="alignRight">
                                                <?php echo moneyFormatIndia(number_format((float)($total_cgst), 2, '.', '')); ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                        ...
                                        <tr>
                                            <td colspan="6"></td>
                                            <td colspan="2" class="alignRight">IGST
                                                <?php echo (sizeof($est_other_item['tax_details']) == 1 ? '(' . ($est_other_item['item_details'][0]['tax_percentage']) . '%)' : '') ?>
                                            </td>
                                            <td class="alignRight" style="font-size:15px !important;">Rs</td>
                                            <td class="alignRight">
                                                <?php echo moneyFormatIndia(number_format((float)($total_igst), 2, '.', '')); ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="alignRight" style="font-size:15px !important;">Rs</td>
                                            <td class="alignRight">
                                                <?php echo moneyFormatIndia(number_format($billing['handling_charges'], 2, '.', '')); ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="alignRight" style="font-size:15px !important;">Rs</td>
                                            <td class="alignRight">
                                                <?php echo moneyFormatIndia(number_format($billing['round_off_amt'], 2, '.', '')); ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="9"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="alignRight" style="font-size:15px !important;">Rs</td>
                                            <th class="alignRight" style="font-size: 12px;">
                                                <?php echo moneyFormatIndia(number_format(round($tot_sales_amt + $billing['handling_charges'] + $billing['round_off_amt']), 2, '.', '')); ?>
                                            </th>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="alignRight" style="font-size:15px !important;">Rs</td>
                                            <th class="alignRight" style="font-size: 12px;">
                                                <?php echo moneyFormatIndia(number_format(($tot_sales_amt), 2, '.', '')); ?>
                                            </th>
                                        </tr>
                                        <?php } ?>
                                        ...
                                        <tr>
                                            <td colspan="6"></td>
                                            <td colspan="2" class="alignRight">TCS
                                                (<?php echo $billing['tcs_tax_per'] . '%'; ?>)</td>
                                            <td class="alignRight" style="font-size:15px !important;">Rs</td>
                                            <td class="alignRight">
                                                <?php echo moneyFormatIndia(number_format($billing['tcs_tax_amt'], 2, '.', '')); ?>
                                            </td>
                                        </tr>
                                        ...
                                        <tr style="font-weight:bold">
                                            ...
                                            <td class="alignRight" style="font-size:15px !important;">Rs</td>
                                            <td class="alignRight">
                                                <?php echo moneyFormatIndia(number_format($tot_sales_amt + $billing['handling_charges'] + $billing['tcs_tax_amt'] - $scheme_benefit, 2, '.', '')); ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </table>
                        ...
                        <table id="pp" class="table text-center">
                            ...
                            <thead style="text-transform:uppercase;font-size:12px;">
                                <tr>
                                    <th class="table_heading alignCenter" style="width: 5%; text-align:center;">S.No
                                    </th>
                                    <th class="table_heading textOverflowHidden" style="width: 30%; text-align:left;">
                                        Description </th>
                                    <th class="table_heading alignRight" style="width: 8%;">HSN</th>
                                    <th class="table_heading alignRight" style="width: 5%;">PCS</th>
                                    <th class="table_heading alignRight" style="width: 10%;">GRS.WT</th>
                            ...
                            <tr>
                                ...
                                <td style="width: 26%;" class="textOverflowHidden"><?php echo $items['product_name']; ?>
                                </td>
                                ...
                                <td style="width: 15%" class="alignRight">
                                    <?php echo ($wastge_wt > 0 ? number_format($wastge_wt, 3, '.', '') : ''); ?></td>
                                <td style="width: 15%" class="alignRight">
                                    <?php echo $mc > 0 ? moneyFormatIndia(number_format($mc, 2, '.', '')) : ''; ?></td>
                                ...
                                <td style="width: 15%" class="alignRight">
                                    <?php echo moneyFormatIndia($items['rate_per_grm']); ?></td>
                                <td style="width: 15%" class="alignRight">
                                    <?php echo moneyFormatIndia(number_format($item_cost, 2, '.', '')); ?></td>
                            </tr>
                            <?php $i++;
                            ...
                            <tr style="font-weight: bold">
                                ...
                                <td></td>
                                <td class="alignRight">
                                    <?php echo moneyFormatIndia(number_format((float)$return_item_cost, '2', '.', '')); ?>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="10">
                            ...
                            <tr>
                                ...
                                <td class="alignRight" style="font-size:15px !important;">Rs</td>
                                <td class="alignRight">
                                    <?php echo moneyFormatIndia(number_format($total_sgst, 2, '.', '')); ?></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="alignRight" style="font-size:15px !important;">Rs</td>
                                <td class="alignRight">
                                    <?php echo moneyFormatIndia(number_format($total_cgst, 2, '.', '')); ?></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="alignRight" style="font-size:15px !important;">Rs</td>
                                <td class="alignRight">
                                    <?php echo moneyFormatIndia(number_format($total_return, 2, '.', '')); ?></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="alignRight" style="font-size:15px !important;">Rs</td>
                                <td class="alignRight">
                                    <?php echo moneyFormatIndia(number_format($tot_sales_amt + $billing['handling_charges'] - $scheme_benefit, 2, '.', '')); ?>
                                </td>
                            </tr>
                            <?php } ?>
                            ...
                            <tr>
                                <td colspan="6"></td>
                                <td colspan="2" class="alignRight">Exchange Amount</td>
                                <td class="alignRight" style="font-size:15px !important;">Rs</td>
                                <td class="alignRight">
                                    <?php echo moneyFormatIndia(number_format($total_return - $billing['credit_due_amt'] - $round_off, 2, '.', '')); ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="alignRight" style="font-size:15px !important;">Rs</td>
                                <td class="alignRight">
                                    <?php echo moneyFormatIndia(number_format(round(($tot_sales_amt + $billing['handling_charges']) - $total_return + $round_off), 2, '.', '')); ?>
                                </td>
                            </tr>
                            <?php }
											} ?>
                            ...
                            <div class="table-responsive">
                                <table id="pp" class="table text-center">
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size:10px !important;"><?php echo $items['category_name']; ?>
                                        </td>
                                        <td><?php echo $items['piece']; ?></td>
                                        <td><?php echo $items['gross_wt']; ?></td>
                                        <td class="alignRight"><?php echo $items['rate_per_grm']; ?></td>
                                        <td class="alignRight"><?php echo number_format($item_taxable, 2, '.', ''); ?>
                                        </td>
                                    </tr>
                                    <?php $i++;
													} ?>
                                    ...
                                    <tr class="total">
                                        ...
                                        <td style="text-align:right;">
                                            <?php echo number_format((float)($taxable_amt + $bill_discount), 2, '.', ''); ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td width="1%;"></td>
                                        <td style="text-align:right;">
                                            <?php echo number_format($bill_discount, 2, '.', ''); ?></td>
                                    </tr>
                                    <?php } ?>
                                    <?php if ($taxable_amt > 0) { ?>
                                    <tr>
                                        ...
                                        <td style="text-align:right;">
                                            <?php echo number_format((float)($taxable_amt), 2, '.', ''); ?></td>
                                    </tr>
                                    <?php } ?>
                                    ...
                                    <tr>
                                        ...
                                        <td width="4">SGST</td>
                                        <td width="1%;">
                                            <?php echo ($est_other_item['sales_ret_trans_details'][0]['tax_percentage'] / 2) . '%' ?>
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="4"></td>
                                        <td width="">IGST
                                            <?php echo ($est_other_item['sales_ret_trans_details'][0]['tax_percentage']) . '%' ?>
                                        </td>
                                        <td width="1%;" style="font-size:15px !important;">Rs</td>
                                    ...
                                    <tr>
                                        ...
                                        <td width="1%;" style="font-size:15px !important;">Rs</td>
                                        <td style="text-align:right;">
                                            <?php echo number_format($billing['round_off_amt'], 2, '.', ''); ?></td>
                                    ...
                                    <tr>
                                        ...
                                        <td width="1%;" style="font-size:15px !important;"
                                            style="font-size:15px !important;">Rs</td>
                                        <th style="text-align:right;font-size: 12px;">
                                            <?php echo number_format(($billing['tot_bill_amount'] < 0 ? ($billing['tot_bill_amount'] * -1) : $billing['tot_bill_amount']), 2, '.', ''); ?>
                                        </th>
                            ...
                            <div class="table-responsive">
                                ...
                                <table id="pp" class="table text-center">
                                    ...
                                    <tr style="text-transform:uppercase;font-size:12px;">
                                        ...
                                        <th class="table_heading " style="width: 30%; text-align:left;">Description
                                        </th>
                                        <th class="table_heading alignRight" style="width: 8%;">HSN</th>
                                        <th class="table_heading alignRight" style="width: 5%;">PCS</th>
                                        <th class="table_heading alignRight" style="width: 10%;">GRS.WT</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class='textOverflowHidden '>
                                            <?php echo $items['product_name']; ?><?php echo " -" . $items['sub_design_name']; ?>
                                        </td>
                                        <td class="alignRight"><?php echo $items['hsn_code']; ?></td>
                                        <!-- <td><?php echo $items['purname']; ?></td> -->
                                        <td class="alignRight"><?php echo $items['totalitems']; ?></td>
                                        <td class="alignRight">
                                            <?php echo $items['weight'] . ($items['pro_uom'] != '' ? '-' . $items['pro_uom'] : ''); ?>
                                        </td>
                                        <td class="alignRight">
                                            <?php echo (!empty($items['net_wt']) ? $items['net_wt'] : '') . ($items['pro_uom'] != '' ? '-' . $items['pro_uom'] : ''); ?>
                                        </td>
                                        <td class="alignRight"><?php
																					if ($items['net_wt'] >= 1) {
                                        ...
                                        <td class="alignRight">
                                            <?php echo moneyFormatIndia($rate_without_gst - $stone_amount, 2, '.', ''); ?>
                                        </td>
                                    </tr>
                                    <?php
                                    ...
                                    <tr class="stones">
                                        ...
                                        <?php if ($stoneItems['stone_cal_type'] == 1) { ?>
                                        <td colspan="4" class='textOverflowHidden stoneData'>
                                            <?php echo $stoneItems['pieces'] . ' Pcs ' . $stoneItems['stone_name'] . ($stoneItems['amount'] > 0 ? ' ' . number_format($stoneItems['wt'], 3, '.', '') . ' ' . $stoneItems['uom_short_code'] . 'x' . moneyFormatIndia(($stoneItems['rate_per_gram']), 2, '.', '') . '=' . moneyFormatIndia(number_format((float)($stoneItems['amount']), 2, '.', '')) : ''); ?>
                                        </td>
                                        <?php } else if ($stoneItems['stone_cal_type'] == 2) { ?>
                                        <td colspan="4" class='textOverflowHidden stoneData'>
                                            <?php echo number_format($stoneItems['wt'], 3, '.', '') . ' ' . $stoneItems['uom_short_code'] . ' ' . $stoneItems['stone_name'] . ($stoneItems['amount'] > 0 ? ' ' . $stoneItems['pieces'] . 'Pcs ' . 'x' . $stoneItems['rate_per_gram'] . '=' . moneyFormatIndia(number_format((float)($stoneItems['amount']), 2, '.', '')) : ''); ?>
                                    ...
                                    <tr class="total" style="font-weight: bold">
                                        ...
                                        <td class="alignRight">
                                            <?php echo moneyFormatIndia(number_format((float)($od_total_price_without_gst), 2, '.', '')); ?>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td colspan="6"></td>
                                        <td class="alignRight">CGST <?php echo ($items['tax_percentage'] / 2) . '%'; ?>
                                        </td>
                                        <td class="alignRight" style="font-size:15px !important;">Rs</td>
                                        <td class="alignRight">
                                            <?php echo moneyFormatIndia($od_total_cgst, 2, '.', ''); ?></td>
                                    </tr>

                                    <tr>
                                        <td colspan="6"></td>
                                        <td class="alignRight">SGST <?php echo ($items['tax_percentage'] / 2) . '%'; ?>
                                        </td>
                                        <td class="alignRight" style="font-size:15px !important;">Rs</td>
                                        <td class="alignRight">
                                            <?php echo moneyFormatIndia($od_total_sgst, 2, '.', ''); ?></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="alignRight" style="font-size:15px !important;">Rs</td>
                                        <td class="alignRight">
                                            <?php echo moneyFormatIndia($od_total_igst, 2, '.', ''); ?></td>
                                    </tr>
                                    ...
                                    <tr class="table_heading">
                                        ...
                                        <td class="alignRight" style="font-size:15px !important;">Rs</td>
                                        <td class="alignRight">
                                            <?php echo moneyFormatIndia($od_total_price, 2, '.', ''); ?></td>
                                    </tr>
                                    <tr>
                                        <td colspan="8"></td>
                                        <td>
                    ...
                    <div class="table-responsive">
                        <table id="pp" class="table text-center">
                            <thead style="text-transform:uppercase;font-size:10px; font-weight:bold;">
                                <tr>
                                    <td width="10%;" class="alignCenter">S.No</td>
                                    <td width="10%;">HSN</td>
                            ...
                            <tr>
                                ...
                                <td style="text-align:right;">
                                    <?php echo moneyFormatIndia(number_format($item_taxable, 2, '.', '')); ?></td>
                            </tr>
                            <?php $i++;
											} ?>
                            <!--</tbody> -->
                            ...
                            <tr class="total">
                                ...
                                <td></td>
                                <td style="text-align:right;">
                                    <?php echo moneyFormatIndia(number_format((float)($taxable_amt + $bill_discount), 2, '.', '')); ?>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td colspan="3"></td>
                                <td width="">LESS DISC</td>
                                <td style="text-align:right; font-size:15px !important;"><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span></td>
                                <td style="text-align:right;">
                                    <?php echo moneyFormatIndia(number_format($bill_discount, 2, '.', '')); ?></td>
                            </tr>
                            <?php } ?>
                            <?php if ($taxable_amt > 0) { ?>
                            <tr>
                                <td colspan="4"></td>
                                <td width="">SUB TOTAL</td>
                                <td style="font-size:15px !important; text-align:right;"><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span></td>
                                <td style="text-align:right;">
                                    <?php echo moneyFormatIndia(number_format((float)($taxable_amt), 2, '.', '')); ?>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="4"></td>
                                <td width="4">SGST
                                    (<?php echo ($est_other_item['sales_trasnfer_details'][0]['tax_percentage'] / 2) . '%' ?>)
                                </td>
                                <td style="text-align:right; font-size:15px !important;"><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span></td>
                                <td style="text-align:right;">
                                    <?php echo moneyFormatIndia(number_format($total_sgst, 2, '.', '')); ?></td>
                            ...
                            <tr>
                                <td colspan="4"></td>
                                <td width="">IGST
                                    (<?php echo ($est_other_item['sales_trasnfer_details'][0]['tax_percentage']) . '%' ?>)
                                </td>
                                <td style="text-align:right; font-size:15px !important;"><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span></td>
                                <td style="text-align:right;">
                                    <?php echo moneyFormatIndia(number_format($total_igst, 2, '.', '')); ?></td>
                            </tr>
                            <?php } ?>
                            ...
                            <tr>
                                <td colspan="4"></td>
                                <td width="">Round Off</td>
                                <td width="1%;" style="font-size:15px !important;"><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span></td>
                                <td style="text-align:right;">
                                    <?php echo moneyFormatIndia(number_format($billing['round_off_amt'], 2, '.', '')); ?>
                                </td>
                            ...
                            <tr style="font-weight:bold;">
                                ...
                                <td style="text-align:right; font-size: 12px; ">
                                    <?php echo moneyFormatIndia(number_format($billing['tot_bill_amount'], 2, '.', '')); ?>
                                </td>
            ...
            <?php
							...
							?>
            <span style="font-size:12px !important; font-weight:bold; text-transform: uppercase;">Purchase Invoice No :
                <?php echo $pur_inv_no; ?></span>
            ...
            <table id="pp" class="table text-center">
                ...
                <tr style="text-transform:uppercase;font-size:12px;">
                    ...
                    <th colspan="2" class="table_heading textOverflowHidden" style="width: 35%; text-align:left;">
                        Description </th>
                ...
                <tr>
                    ...
                    <td style="font-size:10px; width:35%" colspan="2" class='textOverflowHidden'>
                        <?php echo $items['old_metal_type']; ?></td>
                    <td style="width: 24%" style="width: 8%" class="alignRight">
                        <?php echo number_format($items['gross_wt'], 3, '.', ''); ?></td>
                    <td style="width: 10%" class="alignRight">
                        <?php echo $items['stone_wt'] > 0 ? $items['stone_wt'] : ''; ?></td>
                    <td style="width: 10%" class="alignRight">
                        <?php echo ($items['wast_wt'] + $items['dust_wt'] + $items['less_wt'] > 0 ? number_format(($items['wast_wt'] + $items['dust_wt'] + $items['less_wt']), 3, '.', '') : ''); ?>
                    </td>
                    <td style="width: 10%" class="alignRight"><?php echo number_format($items['net_wt'], 3, '.', ''); ?>
                    </td>
                    <td style="width: 12%" class="alignRight"><?php echo moneyFormatIndia($items['rate_per_gram']); ?>
                    </td>
                    <td style="width: 12%" class="alignRight">
                        <?php echo moneyFormatIndia(number_format($items['amount'], 2, '.', '')); ?></td>
                </tr>
                <?php $i++;
								} ?>
                <!-- stone details-->
                ...
                <tr class="stones">
                    ...
                    <?php if ($stoneItems['stone_cal_type'] == 1) { ?>
                    <td colspan="4" class='textOverflowHidden stoneData'>
                        <?php echo $stoneItems['pieces'] . ' Pcs ' . $stoneItems['stone_name'] . ($stoneItems['price'] > 0 ? ' ' . number_format($stoneItems['wt'], 3, '.', '') . ' ' . $stoneItems['uom_short_code'] . ' x ' . moneyFormatIndia(($stoneItems['rate_per_gram']), 2, '.', '') . '=' . moneyFormatIndia(number_format((float)($stoneItems['price']), 2, '.', '')) : ''); ?>
                    </td>
                    <?php } else if ($stoneItems['stone_cal_type'] == 2) { ?>
                    <td colspan="4" class='textOverflowHidden stoneData'>
                        <?php echo number_format($stoneItems['wt'], 3, '.', '') . ' ' . $stoneItems['uom_short_code'] . ' ' . $stoneItems['stone_name'] . ($stoneItems['price'] > 0 ? ' ' . $stoneItems['pieces'] . 'Pcs ' . 'x' . $stoneItems['rate_per_gram'] . '=' . moneyFormatIndia(number_format((float)($stoneItems['price']), 2, '.', '')) : ''); ?>
                    </td>
                    <?php } ?>
                    <td class="alignRight stoneData"></td>
                    <td class="alignRight stoneData"></td>
                ...
                <tr style="font-weight: bold">
                    ...
                    <td></td>
                    <td class="alignRight">
                        <?php echo moneyFormatIndia(number_format((float)$pur_total_amt, 2, '.', '')); ?></td>
                </tr>
                <tr>
                    <td colspan="9">
                        <hr class="old_metal_dashed">
                ...
                <tr style="font-weight: bold">
                    ...
                    <td class="alignRight" style="font-size:15px !important;">Rs</td>
                    <td class="alignRight">
                        <?php echo moneyFormatIndia((number_format($tot_sales_amt + $billing['handling_charges'], 2, '.', ''))); ?>
                    </td>
                </tr>
                <?php } ?>
                <?php if ($total_return > 0) { ?>
                <tr style="font-weight: bold">
                    ...
                    <td class="alignRight" style="font-size:15px !important;">Rs</td>
                    <td class="alignRight"><?php echo moneyFormatIndia(number_format($total_return, 2, '.', '')); ?>
                    </td>
                </tr>
                <?php } ?>
                ...
                <tr style="font-weight: bold">
                    ...
                    <td class="alignRight" style="font-size:15px !important;">Rs</td>
                    <td class="alignRight">
                        <?php echo moneyFormatIndia(number_format(round(($tot_sales_amt + $billing['handling_charges']) - $total_return - $pur_total_amt + $round_off), 2, '.', '')); ?>
                    </td>
                </tr>
                <?php } ?>
            </table>
            ...
            <div class="row">
                <div align="center">
                    <label><b>ORDER NO :
                            <?php echo $est_other_item['repair_order_details'][0]['order_no']; ?></b></label>
                </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <table id="pp" class="table text-center">
                            ...
                            <tr>
                                ...
                                <td class="alignRight">
                                    <?php echo moneyFormatIndia(number_format($items['rate'] - $items['repair_tot_tax'], 2, '.', '')); ?>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="alignRight">
                                    <?php echo moneyFormatIndia(number_format($taxable_amt, 2, '.', '')); ?></td>
                            </tr>
                            <tr>
                                <td colspan="5">
                                    <hr class="old_metal_dashed">
                            ...
                            <table class="table" style="width:100%">
                                ...
                                <tbody> <?php if ($tot_repair_amt > 0) { ?>
                                    <tr>
                                        ...
                                        <td class="alignRight" style="font-size:15px !important;">Rs</td>
                                        <td class="alignRight"><?php echo number_format($taxable_amt, 2, '.', ''); ?>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                    ...
                                    <tr>
                                        <td colspan="7"></td>
                                        <td class="alignRight" width="">CGST</td>
                                        <td class="alignRight" style="font-size:15px !important;">Rs</td>
                                        <td class="alignRight"><?php echo number_format($cgst, 2, '.', ''); ?></td>
                                    </tr>
                                    <tr>
                                        <td colspan="7"></td>
                                        <td class="alignRight" width="">SGST</td>
                                        <td class="alignRight" style="font-size:15px !important;">Rs</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="alignRight" width="">IGST</td>
                                        <td class="alignRight" style="font-size:15px !important;">Rs</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="alignRight" style="font-size:15px !important;">Rs</td>
                                        <th class="alignRight" style="font-size: 12px;">
                                            <?php echo number_format($tot_repair_amt, 2, '.', ''); ?></th>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="alignRight" style="font-size:15px !important;">Rs</td>
                                        <td class="alignRight">
                                            <?php echo moneyFormatIndia(number_format((float)($taxable_amt +$sgst +$cgst + $tot_sales_amt), 2, '.', '')); ?>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
                ...
                <div class="col-xs-12">
                    <div class="table-responsive">
                        ...
                        <table id="pp" class="table text-center">
                            ...
                            <tr>
                                <td><?php echo 'Received with thanks from Mr./Ms.' . $billing['customer_name'] . ' Towards Credit Bill No : ' . $billing['ref_bill_no']; ?>
                                </td>
                                <td class="alignRight">
                                    <?php echo moneyFormatIndia(number_format($billing['due_amount'], 2, '.', '')); ?>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                            ...
                            <tr>
                                ...
                                <td style="font-weight:bold" class="alignRight">
                                    <?php echo moneyFormatIndia(number_format($billing['due_amount'], 2, '.', '')); ?>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="font-weight:bold" class="alignRight">
                                    <?php echo moneyFormatIndia(number_format($billing['tot_amt_received'], 2, '.', '')); ?>
                                </td>
                            </tr>
                            <?php if ($pur_total_amt > 0) { ?>
                            <tr>
                                ...
                                <td style="font-weight:bold" class="alignRight">
                                    <?php echo moneyFormatIndia(number_format($pur_total_amt, 2, '.', '')); ?></td>
                            </tr>
                            <?php } ?>
                            <?php
											if ($due_amount >= 0) { ?>
                            <tr>
                                ...
                                <td class="alignRight">
                                    <?php echo moneyFormatIndia(number_format($due_amount, 2, '.', '')); ?></td>
                            </tr>
                            <?php } else { ?>
                            <tr>
                                <td>Balance as on Today</td>
            ...
            <table>
                <?php
							$get_other_adv_details = $this->ret_billing_model->get_previous_order_details($order_no, $billing['bill_id'], $billing['id_branch'], $billing['bill_created_time']);
                ...
                <tr style="font-weight: bold;">
                    ...
                    <td class="alignRight" style="font-size:15px !important;">Rs</td>
                    <td class="alignRight"><?php echo moneyFormatIndia(number_format($od_total_price, 2, '.', '')); ?>
                    </td>
                </tr>
                <?php }
							$tot_adv_amt = 0;
                    ...
                    <table id="pp" class="table text-center">
                        <thead style="text-transform:uppercase;font-size:17px;">
                            <tr>
                                ...
                                <td class="table_heading" style="width: 14% !important;text-align:center;" colspan="2">
                                    SGST </td>
                        ...
                        <tr>
                            ...
                            <td class="alignRight">
                                <?php echo moneyFormatIndia(number_format($item_taxable, 2, '.', '')); ?></td>
                            <td class="alignRight">
                                <?php echo ($items['total_cgst'] > 0 ? ($items['tax_percentage'] / 2) . '%' : 0); ?>
                            </td>
                            <td class="alignRight">
                                <?php echo ($items['total_cgst'] > 0 ? ($items['total_cgst']) : 0); ?></td>
                            <td class="alignRight">
                                <?php echo ($items['total_sgst'] > 0 ? ($items['tax_percentage'] / 2) . '%' : 0); ?>
                            </td>
                            <td class="alignRight">
                                <?php echo ($items['total_sgst'] > 0 ? ($items['total_sgst']) : 0); ?></td>
                            <td class="alignRight">
                                <?php echo ($items['total_igst'] > 0 ? ($items['tax_percentage']) . '%' : 0); ?></td>
                            <td class="alignRight">
                                <?php echo ($items['total_igst'] > 0 ? ($items['total_igst']) : 0); ?></td>
        ...
        <table id="pp" class="table" style="font-size: 12px;">
            ...
            <thead style="text-transform:uppercase; visibility:hidden;">
                <tr>
                    ...
                    <th colspan="2" class="table_heading textOverflowHidden"
                        style="width:<?php echo sizeof($est_other_item['old_matel_details']) > 0 || sizeof($est_other_item['return_details']) > 0 || sizeof($est_other_item['order_details']) > 0 ? '44%' : '39%' ?>; text-align:left;">
                    </th>
            ...
            <tr>
                ...
                <th class="alignRight" style="font-size:15px !important;">Rs</th>
                <th class="alignRight">
                    <?php echo moneyFormatIndia(number_format(round($chit_adj + $scheme_benefit), 2, '.', '')); ?></th>
            </tr>
            <tr>
                <td colspan="8"></td>
                <td>
            ...
            <tr>
                ...
                <th class="alignRight" style="font-size:15px !important;">Rs</th>
                <th class="alignRight">
                    <?php echo moneyFormatIndia(number_format(round($tot_sales_amt + $billing['handling_charges'] - $pur_total_amt - $total_return + $round_off - ($chit_adj + $scheme_benefit)), 2, '.', '')); ?>
                </th>
            </tr>
            <?php } ?>
            ...
            <tr>
                ...
                <th class="alignRight" style="font-size:15px !important;">Rs</th>
                <th class="alignRight">
                    <?php echo moneyFormatIndia(number_format($ord_adj_amt + $billing['adv_adj_amt'], 2, '.', '')); ?>
                </th>
            </tr>
            <?php } ?>
            <?php if ($chq_amt > 0) { ?>
            ...
            <tr>
                <td colspan="6">
                    <?php echo 'Chq No: ' . $chq['cheque_no'] . '/  ' . $chq['payment_ref_number'] . 'Date: ' . $chq['cheque_date']; ?>
                </td>
                <th colspan="1" class="alignRight">CHEQUE</th>
                <th class="alignRight" style="font-size:15px !important;">Rs</th>
                <th class="alignRight">
                    <?php echo moneyFormatIndia(number_format($chq['payment_amount'], 2, '.', '')); ?></th>
            </tr>
            <?php }
								}
							} ?>
            ...
            <tr>
                <td colspan="6">
                    <?php echo 'Card No: ' . $cardItem['card_no'] . '/ Appr code: ' . $cardItem['payment_ref_number'] . '/ Date: ' . $cardItem['payment_date']; ?>
                </td>
                <th colspan="1" class="alignRight">CARD</th>
                <th class="alignRight" style="font-size:15px !important;">Rs</th>
                <th class="alignRight">
                    <?php echo moneyFormatIndia(number_format($cardItem['payment_amount'], 2, '.', '')); ?></th>
            </tr>
            <?php }
								}
							} ?>
            ...
            <tr>
                <td colspan="6">
                    <?php echo $rtgs['device_name'] . '/ Appr code: ' . $rtgs['payment_ref_number'] . '/' . 'Date: ' . $rtgs['net_banking_date']; ?>
                    </th>
                <th colspan="1" class="alignRight">RTGS
                    </td>
                <th class="alignRight" style="font-size:15px !important;">Rs</th>
                <th class="alignRight">
                    <?php echo moneyFormatIndia(number_format($rtgs['payment_amount'], 2, '.', '')); ?></th>
            </tr>
            <?php }
								}
							} ?>
            ...
            <tr>
                <td colspan="6">
                    <?php echo $imps['device_name'] . '/ Appr code: ' . $imps['payment_ref_number'] . '/' . 'Date: ' . $imps['net_banking_date']; ?>
                    </th>
                <th colspan="1" class="alignRight">IMPS</td>
                <th class="alignRight" style="font-size:15px !important;">Rs</th>
                <th class="alignRight">
                    <?php echo moneyFormatIndia(number_format($imps['payment_amount'], 2, '.', '')); ?></th>
            </tr>
            <?php }
							}
						} ?>
            ...
            <tr>
                <td colspan="6">
                    <?php echo $neft['device_name'] . '/ Appr code: ' . $neft['payment_ref_number'] . '/' . 'Date: ' . $neft['net_banking_date']; ?>
                    </th>
                <th colspan="1" class="alignRight">NEFT</td>
                <th class="alignRight" style="font-size:15px !important;">Rs</th>
                <th class="alignRight">
                    <?php echo moneyFormatIndia(number_format($neft['payment_amount'], 2, '.', '')); ?></th>
            </tr>
            <?php }
							}
						} ?>
            ...
            <tr>
                <td colspan="6">
                    <?php echo $upi['device_name'] . '/ Appr code: ' . $upi['payment_ref_number'] . '/' . 'Date: ' . $upi['net_banking_date']; ?>
                    </th>
                <th colspan="1" class="alignRight">UPI</td>
                <th class="alignRight" style="font-size:15px !important;">Rs</th>
                <th class="alignRight">
                    <?php echo moneyFormatIndia(number_format($upi['payment_amount'], 2, '.', '')); ?></th>
            </tr>
            <?php }
							}
						} ?>
            ...
            <tr>
                <td colspan="5"></td>
                <th colspan="2" class="alignRight">DUE AMOUNT</th>
                <th class="alignRight" style="font-size:15px !important;">Rs</th>
            ...
            <tr>
                ...
                <th class="alignRight" style="font-size:15px !important;">Rs</th>
                <th class="alignRight">
                    <?php echo moneyFormatIndia(number_format($billing['credit_disc_amt'], 2, '.', '')); ?></th>
            </tr>
            <?php } ?>
            ...
            <tr>
                ...
                <th class="alignRight" style="font-size:15px !important;">Rs</th>
                <th class="alignRight">
                    <?php echo moneyFormatIndia(number_format($billing['advance_deposit'], 2, '.', '')) ?></th>
            </tr>
            <?php } ?>
        ...
        <table id="pp" class="pay_mode_totals table text-center" style=" font-size: 12px;">
            ...
            <thead style="text-transform:uppercase; visibility:hidden;">
                <tr>
                    <th class="table_heading alignCenter" style="width: 5%; text-align:center;"></th>
                    <th colspan="2" class="table_heading textOverflowHidden"
                        style="width:<?php echo (sizeof($est_other_item['old_matel_details']) > 0) || (sizeof($est_other_item['order_details']) > 0) || (sizeof($est_other_item['return_details']) > 0) ? '44%' : '39%' ?>; text-align:left;">
                    </th>
                    <!-- <th class="table_heading alignRight" style="width: 8%;"></th> -->
                    <th class="table_heading alignRight" style="width: 5%;"></th>
                    <th class="table_heading alignRight" style="width: 10%;"></th>
	...
	?>
        <table>
            ...
            <tr style="font-weight: bold;">
                <td colspan="3"></td>
                <td colspan="4" class="alignRight">Balance Wt
                    (<?php echo moneyFormatIndia(number_format($od_balance, 2, '.', '')) . ' / ' . moneyFormatIndia($first_rate); ?>)
                </td>
                <td class="alignRight"></td>
                <td class="alignRight">
                    <?php echo moneyFormatIndia(number_format($od_metal_balance, 3, '.', '')) . 'Gm'; ?></td>
            </tr>
            <?php } else { ?>
            <tr style="font-weight: bold;">
                <td colspan="3"></td>
        ...
        <div class="col-xs-6">
            <div class="table-responsive">
                <table id="pp" class="table text-center">
                    ...
                    <?php $i++;
						$sheme_close += $chit['closing_amount'];
					}
					if ($scheme_benefit > 0) {
					?>
                    <tr>
            ...
            <div class="table-responsive">
                ...
                <table id="pp" class="table text-center">
                    ...
                    <tr>
                        ...
                        <td colspan="2" class="alignRight">
                            <?php echo moneyFormatIndia(number_format(($ord['store_as'] == 1 && $ord['advance_amount'] > 0 ? $ord['advance_amount'] : ($ord['received_weight'] * $ord['rate_per_gram'])), 2, '.', '')); ?>
                        </td>
                        <td colspan="5"></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td colspan="2" class="alignRight">
                            <?php echo moneyFormatIndia(number_format($adv_paid_amount, 2, '.', '')) ?></td>
                        <td colspan="5"></td>
                    </tr>
                </table>
            </div>
        ...
        <span>Gift Voucher Worth Rs <?php echo ' ' . $billing['gift_issue_amount'] . ' ' ?>Valid Till
            <?php echo $billing['valid_to'] . '. Voucher Code - ' . $billing['code'] . ''; ?></span>
        <?php } else if ($billing['gift_issue_weight'] > 0) { ?>
        <span>Gift Voucher Worth
            <?php echo ' ' . $billing['gift_issue_weight'] . ' ' . (($billing['utilize_for']) == 1 ? ' Gold ' : ' Silver ') . ' ' ?>Valid
            Till <?php echo $billing['valid_to'] . '. Voucher Code - ' . $billing['code'] . ''; ?></span>
        <?php } ?>
        <?php
	if ($billing['note'] != '') { ?>
    ...
    <div class="footer">
        <div style="position:relative; height: 50px; width:100%; font-weight:bold; bottom:0;">

            <div style="font-size:16px; text-align:left;width:65%; float:left;">Customer Signature</div>
            <div style="font-size:16px; text-align:Right; width:35%; float:right;">For
                <?php echo $comp_details['company_name']?></div>

        </div>

        <div style="font-size:11px; width:98%; height:15px; text-align:justify;">
            <p>*Amount of tax (Invoice Inwards) subject to reverse charge. *Received ornaments in good condition. *The
                Hallmarking charge is included in the invoice.*The consumer can get the purity of the hallmarked
                jewellery/artefacts checked from any of the BIS recognized A&H center. The list of BIS recognized A&H
                centers along with address and contact details are available in the website:www.bis.gov.in
                E.&O.E</p>
        </div><br>
