...
<?php if (sizeof($receiptDetails) > 0) {
														...
														<table id="pp" style="width:99%; border-collapse:collapse; font-size:10px;">
															<thead style="text-transform:uppercase;font-size:10px;">
																...
																<tr>
																	...
																	<th class="table_heading alignRight" style="width: 7%; text-align:right; padding:3px; border:none;">V.A</th>
	...
	<?php if ($due_amount > 0) { ?>
		<tr>
			...
			<th class="alignCenter">Rs</th>
			<th class="alignRight"><?php echo moneyFormatIndia(number_format($due_amount, 0, '.', '')); ?></th>
		</tr>
	<?php } ?>
	...
	<?php if ($billing['credit_disc_amt'] != 0) { ?>
		<tr>
			...
			<th class="alignCenter" style="font-size:12px;">Rs</th>
		...
		<table>
			...
			<?php } else { ?>
				<tr style="font-weight: bold;">
					...
					<td class="alignCenter">Rs</td>
					<td class="alignRight"><?php echo moneyFormatIndia(number_format($od_balance, 0, '.', '')); ?></td>
				</tr>
			<?php } ?>
