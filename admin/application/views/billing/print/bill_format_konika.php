...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/billing_receipt_konika.css">
	...
	<style>
		...
		.wrapper {
			display: flex;
			width: 100%;
			<?php if ($billing['is_eda'] == 1) { ?>height: 130px;
			<?php } else { ?>height: 50px;
			<?php } ?>
		}
		...
		<table class=paging>
					...
					<td>
						<div class="content-block">
							...
							<div style="width:100%;" class="new_tax">
								<div style="text-decoration: underline; text-align:center;"> <?php echo ($billing['is_eda'] == 1 ? 'tax invoice' : 'ROUGH ESTIMATE') ?> </div>
											...
											<table style="font-weight:bold;">
												<tr>
													...
													<td colspan="2" class="alignLeft">
														<?php echo htmlspecialchars($billing['bill_date']) . " " . htmlspecialchars($billing['bill_time']); ?>
													</td>
												</tr>
											</table>
										</div>
							...
							<div>
								...
								if ($billing['bill_type'] == 9) {
									...
									$title = $billing['is_eda'] == 1 ? "SALES AND PURCHASE BILL" : "SALES AND PURCHASE";
								} elseif (sizeof($est_other_item['item_details']) > 0 && sizeof($est_other_item['old_matel_details']) == 0) {
									$title = $billing['is_eda'] == 1 ? "SALES BILL" : "SALES";
									if ($billing['is_to_be'] == 1) {
										$title = 'TO BE ' . $title;
									}
								} elseif (sizeof($est_other_item['item_details']) == 0 && sizeof($est_other_item['old_matel_details']) > 0) {
									$title = $billing['is_eda'] == 1 ? "PURCHASE BILL" : "PURCHASE";
			...
			<tbody>
				<tr>
					<td>
							...
							<div class="box">
														...
														<table id="pp" class="table">
															<thead style="text-transform:uppercase;font-size:12px;">
																...
																<tr>
																	...
																	<th class="table_heading textOverflowHidden" style="width: 28%; text-align:left;">Description </th>
																	...
																	<th class="table_heading alignRight" style="width: 10%;"><?php echo ($is_eda == 2 ? 'PURE WT' : 'NET.WT') ?> </th>
																	<th class="table_heading alignRight" style="width: 9%;">
																		<pre>V.A</pre>
																	</th>
															...
															<tbody>
																...
																?>
																	<?php 
																	$item_rate = $is_eda ? $items['rate_per_grm'] : $items['pure_rate'] ;
																	?>
																	...
																	<tr>
																		...
																		<?php 
																			$purity_name = round(((float)$items['purname'] / 100) * 24, 0);
																		    echo $is_eda == 1 
																		        ? $items['cat_name'] . ' - ' . $purity_name.'KT'
																		        : $items['product_name'] . ' - ' . $items['design_name']; 
																		?>
																		...
																		<td class="alignRight"><?php echo ($is_eda == 2 ? $items['pure_wt'] : $items['net_wt']) . ($items['pro_uom'] != '' ? '-' . $items['pro_uom'] : ''); ?></td>
																		<!--  <td class="alignRight"> -->
																			<?php
																				// if ($items['net_wt'] >= 1) {
																					// $va_g = round(($wastage_value + $mc) / $items['rate_per_grm'], 0);
																					$va_g = round(($wastage_value) / $items['rate_per_grm'], 3);
																					$va_p = round((($va_g / $items['net_wt']) * 100), 2);
																					// echo $va_g > 0 ? $va_g . "/g " : '';
																					$purity = round($items['purname']);
																					$va_total = $va_p + $purity;
																					// echo $va_p > 0 ? $va_total  : "";
																				// } else {
																				// 	echo round($wastage_value + $mc, 0);
																				// }
																			?> 
																		<!-- </td> -->
																		<!-- <td class="alignRight"><?php echo $wastage_value > 0 ? moneyFormatIndia(number_format($wastage_value, 2, '.', '')) : ''; ?></td> -->
																		<!-- <td class="alignRight"><?php echo ($is_eda == 2 ? $items['wastage_percent'] + $items['purname'] : $items['wastage_percent'] . '%'); ?></td> -->
																		<!-- <td class="alignRight"><?php echo number_format(($is_eda == 2 ? $va_total : $va_p . '%'), 2, '.', ''); ?></td> -->
																		<!-- <td class="alignRight"><?php echo number_format($is_eda == 2 ? $va_total : $va_p . '%'); ?></td> -->
																		<td class="alignRight">
																		    <?php 
																		        if ($is_eda == 2) {
																		            echo is_nan($va_total) ? '' : number_format($va_total, 2);
																		        } else {
																		            echo $va_p > 0 && !is_nan($va_p) ? number_format($va_p, 2) . '%' : '';
																		        }
																		    ?>
																		</td>
																		<td class="alignRight"><?php echo $mc > 0 ? moneyFormatIndia(number_format($mc, 2, '.', '')) : ''; ?></td>
																		<td class="alignRight"><?php echo moneyFormatIndia($item_rate); ?></td>
																		<td class="alignRight"><?php echo moneyFormatIndia(number_format((float)($item_taxable > 0 ? ($item_taxable - $stone_amount) : 0), 2, '.', '')); ?></td>
																	</tr>
																	<!-- <tr>
															<td></td>
															...
															<td colspan="6"></td>
																	...
																	?>
																			<tr class="stones">
																				...
																				<td class="alignRight stone_amt"><?php echo moneyFormatIndia(number_format((float)($stoneItems['amount']), 2, '.', '')) ?></td>
																			</tr>
																		<?php }
																	}
															...
															<tr class="total" style="font-weight: bold">
																...
																<td class="alignRight"><?php echo number_format(($is_eda == 2 ? $pure_wt : $net_wt), 3, '.', ''); ?></td>
																<td></td>
																<td></td>
																<td></td>
												...
												<tr>
													...
													<!-- <td class="alignRight"><?php
																				if ($items['net_wt'] >= 1) {
																					...
																					// echo $va_g > 0 ? $va_g . "/g" : '';
																					$va_g = round(($wastage_value) / $items['rate_per_grm'], 3);
																					$va_p = round((($va_g / $items['net_wt']) * 100), 0);
																					$purity = round($items['purname']);
																					$va_total = $va_p + $purity;
																				} else {
																					echo round($wastage_value + $mc, 0);
								...
								<?php if ($billing['bill_type'] == 5) { ?>
									...
									<div class="row">
										<?php if ($rate_type == '1') { ?>
											<div align="center">
												<label><b>Order No. <?php echo $order_no ?> (RATE FIXED)</b></label>
											</div>
										<?php } else { ?>
											<div align="center">
												<label><b>Order No. <?php echo $order_no ?>  (UNFIXED)</b></label>
											</div>
										<?php } ?>
										<div class="col-xs-12">
											<div class="table-responsive">
												...
												<table id="pp" class="table text-center">
													...
													<tr style="text-transform:uppercase;font-size:12px;">
														...
														<th class="table_heading alignRight" style="width: 10%;">MC</th>
													...
													?>
														<tr>
															...
															<!-- <td class="alignRight"><?php
																					if ($items['net_wt'] >= 1) {
																						$va_g = round(($od_wastage_amt) / $items['net_wt'], 0);
																						echo $va_g > 0 ? $va_g . "/g" : '';
																					} else {
																						echo round($od_wastage_amt + $items['mc'], 0);
																					}
																					?> </td> -->
															<td class="alignRight"><?php echo $items['wast_percent'] > 0 ? $items['wast_percent'].'%' : ''; ?></td>
															<td class="alignRight"><?php echo $items['mc'] > 0 ? moneyFormatIndia(number_format($items['mc'], 2, '.', '')) : ''; ?></td>
													...
													<?php if (($od_total_cgst > 0 || $od_total_sgst > 0) && $is_eda == 1) { ?>
													...
													<?php if ($od_total_igst > 0 && $is_eda == 1) { ?>
													...
													<?php if ($od_total_price > 0) { ?>
														...
														<tr class="table_heading">
															...
															<td class="alignRight" style="font-size:15px !important;">&#8377;</td>
															<td class="alignRight"><?php echo moneyFormatIndia($is_eda == 2 ? $od_total_price_without_gst : $od_total_price, 2, '.', ''); ?></td>
														</tr>
														<tr>
															<td colspan="9"></td>
															<td>
						...
						<?php if (sizeof($est_other_item['old_matel_details']) > 0) { ?>
							...
							<?php if (sizeof($est_other_item['old_matel_details']) > 0 && sizeof($est_other_item['item_details']) == 0 && $billing['bill_type'] != 8) { ?>
								<div for="title" style="text-align:center;font-weight:bold;"><?php $billing['is_eda'] == 1 ? "PURCHASE BILL" : "PURCHASE" ?></div> <br>
							...
							?>
								...
								<?php } else { ?>
									<span style="font-size:12px !important; font-weight:bold; text-transform: uppercase;">Purchase</span>
								<?php } ?>
							<?php } ?>
							<table id="pp" class="table text-center">
								...
								<tr style="text-transform:uppercase;font-size:12px;">
									...
									<th class="table_heading alignRight" style="width: 10%;">GRSWT</th>
								...
								?>
									<tr>
										...
										<td colspan="2" style="width: 24%" style="width: 8%" class="alignRight"><?php echo number_format($items['gross_wt'], 3, '.', ''); ?></td>
										<td></td>
										...
										<td colspan="2" style="width: 12%" class="alignRight"><?php echo moneyFormatIndia(number_format($items['amount'], 2, '.', '')); ?></td>
									</tr>
								<?php $i++;
								} ?>
								<!-- stone details-->
						...
						<table>
							...
							<?php } ?>
							<?php if ($od_total_price > 0 && $rate_type == '1' || $rate_type == '2') { ?>
								<tr class="table_heading">
									<td colspan="5"></td>
									<td colspan="2" class="alignRight">Approximate Total Amount</td>
									<td class="alignRight" style="font-size:15px !important;">&#8377;</td>
									<td class="alignRight"><?php echo moneyFormatIndia($is_eda == 2 ? $od_total_price_without_gst : $od_total_price, 2, '.', ''); ?></td>
								</tr>
							...
							<?php if ($tot_adv_amt > 0) { ?>
								<tr style="font-weight: bold;">
									<td colspan="5"></td>
									<td colspan="2" class="alignRight"> Total Advance Amount</td>
									<td class="alignRight" style="font-size:15px !important;">&#8377;</td>
					...
					<?php if ($billing['is_eda'] == 1) { ?>
						<?php
						if ($cash_amt > 0 || $ord_adj_amt > 0 || $chit_adj > 0 || $chq_amt > 0 || $card_amt > 0 || $upi_amt > 0 || $rtgs_amt > 0 || $imps_amt > 0 || $adv_adj > 0 || $gift_amount > 0 || $billing['advance_deposit'] > 0 || $neft_amt > 0 || $due_amount > 0) { ?>
...
<?php } ?>
	...
	<?php } ?>
	<?php if ($billing['bill_emp_name'] != '' && $billing['is_eda'] == 1) { ?>
		<div style="font-weight:bold;">
			<br>
	...
	<div class="footer">
		...
		<?php } ?>
		<?php if ($billing['is_eda'] == 2) { ?>
			<div style="font-size:16px; width:98%;">
				<p>*GST will be charged extra</p>
			</div>
		<?php } ?>
