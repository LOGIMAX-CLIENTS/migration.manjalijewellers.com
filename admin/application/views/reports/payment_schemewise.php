            ...
            <div class="col-xs-12">
              ...
              <div class="box">
	            ...
	            <div class="row">
	                 	...
	                 	<div class="col-md-12">
	                 	    ...
	                 	    <div class="col-md-3" style="">
    		                  <div class="form-group">
    		                    <div class="input-group">
    		                       <button class="btn btn-default btn_date_range" id="rpt_scheme_payment">
    		                        <span  style="display:none;" id="rpt_scheme_payment1"></span>
									<span  style="display:none;" id="rpt_scheme_payment2"></span>
		                    ...
		                    <div class="col-md-4">               					
                                <?php if($this->session->userdata('branch_settings')==1){?>                              				  
                                    <div class="form-group" style="margin-left: -100px;margin-top: 3px;" >
                  ...
                  <table class="table table-bordered table-striped text-center det_pay_report" id="payment_schemewise" >
                    <thead>
                      <tr>
                        <th>ID</th>
                        <th>Scheme</th>     
