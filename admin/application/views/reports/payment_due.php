      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Payment Dues</li>
          </ol>
        </section>
        ...
        <section class="content report_sel">
          <div class="row">
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Scheme Pending Dues List</h3>      
                     ...
                     <?php 
                      ...
                      <!-- 	 <td><?php echo $account['name'];?></td>-->
                       ...
                       <!--	 <td><?php echo $account['scheme_type'];?></td>-->
                  		 ...
                  		 <td><?php echo $account['total_paid'];?></td>
           ...
           <!--           <td>
                       	 	...
                       	 	<a href="#" class="btn btn-danger btn-del" data-href="<?php echo base_url('index.php/account/delete/'.$account['id_scheme_account']); ?>"  data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash"></i></a>
