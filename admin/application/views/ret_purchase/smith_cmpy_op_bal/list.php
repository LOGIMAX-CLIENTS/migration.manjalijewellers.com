                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                                ...
                                <div class="box box-default">
                                    <div class="box-body">
                                        <div class="row">
                                            ...
                                            <?php if($access['add']==1){?>
                                                <a class="btn btn-success pull-right" id="add_Order" href="<?php echo base_url('index.php/admin_ret_purchase/smith_cmpy_op_bal/add'); ?>"><i class="fa fa-plus-circle"></i> Add</a>
                                                <?php }?>
                                            </div>
                                            <div class="col-md-3"> 
                                            ...
                                            <div class="col-md-2">
                                                <label></label>
                                                <div class="form-group">
                                                    <button type="button" id="smith_cmpy_op_bal_search" class="btn btn-info">Search</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="table-responsive">
                            <table id="smth_cmpy_po_list" class="table table-bordered table-striped text-center">
                                <thead>
                                    <tr>
                                        <th width="5%">#</th>
                                        <th width="9%">Ref No</th>
                                        <th width="9%">Stock Type</th>
                                        <th width="9%">Smith Type</th>
                                        <th width="9%">Balance Type</th>
                                        <th width="9%">Karigar</th>
                                        <th width="9%">Metal</th>
                                        <th width="9%">Category</th>
                                        <th width="9%">Product</th>
                                        <th width="9%">Weight</th>
                                        <th width="9%">Weight Type</th>
                                        <th width="9%">Amount</th>
                                        <th width="9%">Amount Type</th>
