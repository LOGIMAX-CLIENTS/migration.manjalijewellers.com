				...
				<?php 
					...
					<tr>
						...
						<td class="alignRight">
							<?php
							if (
								isset($items['net_wt'], $items['calculation_based_on']) &&
								$items['net_wt'] > 0 &&
								$items['calculation_based_on'] != 3
							) {
								$va_percent = round(($wast_wgt / $items['net_wt']) * 100, 2);
								echo $va_percent > 0 ? $va_percent . "%" : "";
							}
							?>
						</td>
							  ...
							  <?php   }else{
								...
								?>
									...
									<tr>
										...
										<td colspan="3">Scheme Discount</td>
