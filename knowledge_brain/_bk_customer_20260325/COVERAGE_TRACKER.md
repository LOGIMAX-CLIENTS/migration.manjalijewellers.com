...
> **Brain Updated:** 2026-03-17 | **Rounds:** R1 + R2 Complete — **~100% Coverage**
...
| DB tables (owned) | 3 | 3 (customer, address, kyc) | **100%** | ✅ Verified |
| DB tables (referenced) | 14 | 14 | **100%** | ✅ Complete |
...
| File | Lines | Purpose |
|---|---|---|
| `MODULE_BRAIN.md` | ~180 | Architecture, routes, tables, risks, anti-patterns |
| `METHOD_INDEX.md` | ~250 | All 118 methods + JS→Controller map |
| `DATA_FLOW.md` | ~200 | 7 data flows fully traced |
| `BUSINESS_RULES.md` | ~160 | 12 business rules documented |
| `CROSS_MODULE_MAP.md` | ~110 | 14 deps + Mermaid diagram |
| `FORENSIC_TEMPLATE.md` | ~140 | 7-layer investigation guide + SQL queries |
| `DEEP_ANALYSIS_R2.md` | ~220 | Edit path, JS security, model deep bugs |
| `BUG_REGISTER.md` | ~250 | 32 bugs with root cause + fix guidance |
