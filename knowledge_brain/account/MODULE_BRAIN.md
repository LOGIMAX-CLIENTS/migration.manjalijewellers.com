...
> Changes: 0 methods added, 0 removed. `formatMetalWeight()` helper centralized across controller/model/views/JS. Model `get_closed_account_by_id()` adds `is_weight_scheme` + weight formatting. +1 new brain file: FLOW_RISK_MATRIX.md
...
| File | Lines | Purpose |
|---|---|---|
| `admin/assets/js/scheme_account.js` | 4,779 | Account form/list JS logic. 🔄 R2: 10 occurrences of `trimDecimal`/`toFixed(3)` → `formatMetalWeight()` |
...
| 3 | Flow Risk Matrix | [FLOW_RISK_MATRIX.md](FLOW_RISK_MATRIX.md) | ✅ 🔄 NEW R2 |
| 4 | Business Rules | [BUSINESS_RULES.md](BUSINESS_RULES.md) | ✅ Complete |
| 5 | Cross-Module Map | [CROSS_MODULE_MAP.md](CROSS_MODULE_MAP.md) | ✅ Complete |
| 6 | Invariant Matrix | [INVARIANT_MATRIX.md](INVARIANT_MATRIX.md) | ✅ Complete |
| 7 | DB Truth Protocol | [DB_TRUTH_PROTOCOL.sql](DB_TRUTH_PROTOCOL.sql) | ✅ Complete |
| 8 | Forensic Template | [FORENSIC_TEMPLATE.md](FORENSIC_TEMPLATE.md) | ✅ Complete |
| 9 | Method Index | [METHOD_INDEX.md](METHOD_INDEX.md) | ✅ Complete |
| 10 | Schema Analysis | [SCHEMA_ANALYSIS.md](SCHEMA_ANALYSIS.md) | ✅ Complete |
| 11 | Coverage Tracker | [COVERAGE_TRACKER.md](COVERAGE_TRACKER.md) | ✅ Complete |
...
| 16 | **Massive files** — Controller 4,476 lines, Model 3,656 lines | 🟡 MED | Both files |
...
| 19 | 🔄 R2: **DELETE reversal gap** — Account delete only cleans `scheme_account` (1/8 tables = 12.5%) | 🔴 HIGH | Model delete_account() |
| 20 | 🔄 R2: **REVERT reversal gap** — Revert doesn't reverse referral deductions or agent loyalty txns (2/4 = 50%) | 🟡 MED | Controller L1844+ |
