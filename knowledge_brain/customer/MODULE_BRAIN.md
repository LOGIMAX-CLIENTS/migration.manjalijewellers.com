...
> **Module:** customer | **Controller:** `Admin_customer` | **Round:** R3-Upgrade
> **Brain Built:** 2026-03-17 | **Upgraded:** 2026-03-25 | **Status:** R3-Upgrade Complete (100%)
>
> **🔄 UPGRADED BRAIN**
> Previous: R2 (2026-03-17) — 9 files, 43 ctrl methods, 75 model methods, ~100% coverage
> Upgraded: R3 (2026-03-25) — **+3 brain files** (SCHEMA_ANALYSIS, FLOW_RISK_MATRIX, INVARIANT_MATRIX)
> Code Δ: controller -1L (43M unchanged), model 0 (1,254L/75M identical), JS +33L (4,712), views unchanged
> New: 18 QA-ready test scenarios, 3 state machines, 12 inbound contracts, 8 outbound contracts, 10 reversal checks
...
|---|---|---|---|
| `admin/application/controllers/admin_customer.php` | 2,627 | 117 KB | Main controller — CRUD, image upload, KYC, sync, zone, allocations |
| `admin/application/models/customer_model.php` | 1,254 | 62 KB | DB operations — customer, address, kyc, sync tables |
| `admin/assets/js/customer.js` | 4,712 | ~200 KB | All client-side logic — form validation, AJAX, image capture, zone management |
