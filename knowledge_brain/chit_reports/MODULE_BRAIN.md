...
> Built: 2026-03-14 | Last Round: R6-Upgrade (2026-03-25) | Status: ✅ Complete (100%)
>
> **🔄 UPGRADED BRAIN**
> Previous: R5 (2026-03-16) — 13 files, 132 ctrl methods, 100% coverage
> Upgraded: R6 (2026-03-25) — **+1 brain file** (FLOW_RISK_MATRIX.md)
> Code Δ: controller -1L (no method change), payment_model +2,403L (body expansion, 278M unchanged), account_model +9L (170M unchanged), JS +137L, views -4 files (69 total)
> New: 20 QA-ready test scenarios, 3 state machines, 10 inbound contracts, 6 outbound contracts, 9 reversal checks
---
...
| File | Lines | Purpose |
|---|---|---|
| `admin/application/controllers/admin_reports.php` | 2,136 | Main controller — all report routes (132 methods) |
| `admin/application/models/payment_model.php` | 8,903 (278 methods) | Primary data model — payments, accounts, schemes |
| `admin/application/models/account_model.php` | 3,660 (170 methods) | Account/scheme account data |
| `admin/assets/js/reports.js` | 16,286 | Single JS file for all report pages |
