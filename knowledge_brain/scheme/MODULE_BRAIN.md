...
> **Controller**: `admin_scheme.php` (1,240 lines)  
> **Model**: `scheme_model.php` (853 lines)  
...
| `admin/application/views/master/scheme/form.php` | 132,084 bytes | Massive scheme form (all settings). 🔄 R2: Aadhar input ID fixed (`pan_req_amt` → `aadhaar_required_amt`) |
| `admin/application/views/master/scheme/list.php` | 4,241 bytes | Scheme list page |
| `admin/assets/js/scheme.js` | 2,266 lines | Scheme-specific JS |
...
| 16 | 🔄 R2: **View DOM ID mismatch** — `pan_req_amt` used for Aadhar input (fixed in 3ccb4ac1) | ✅ FIXED | View form.php L1014 |
