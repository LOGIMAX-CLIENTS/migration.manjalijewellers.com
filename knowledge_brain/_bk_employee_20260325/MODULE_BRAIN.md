...
> **Module:** employee | **Controller:** `Admin_employee` | **Brain Built:** 2026-03-17  
...
|---|---|---|---|
| `admin/application/controllers/admin_employee.php` | 1366 | 31 KB | Main controller — CRUD, device management, settings, image upload |
| `admin/application/models/employee_model.php` | 1106 | 26 KB | DB ops — employee, address, device, settings, authentication |
| `admin/assets/js/employee.js` | 1428 | 49 KB | Form logic, AJAX, device management UI |
